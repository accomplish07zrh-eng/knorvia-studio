...
const buildResult = await build({
  ...
  bundle: true,
  outfile: "dist/remote/knorvia-server.cjs",
  platform: "node",
  format: "cjs",
  target: "node22",
...
const remoteBundleSource = readFileSync("dist/remote/knorvia-server.cjs", "utf-8");
...
console.log("Built dist/remote/knorvia-server.cjs");
