...
interface SkillStoreState {
  ...
  initialize: (
    ...
    providerOrSkillsService: KnorviaProvider | ISkillsService,
  ...
  setEnabled: (
    skillId: string,
    providerOrEnabled: KnorviaProvider | boolean,
...
export const useSkillStore = create<SkillStoreState>((set, get) => ({
  ...
  async initialize(
    ...
    const provider = normalizeAgentProviderToKnorviaAgent(
      hasProvider ? providerOrSkillsService : KNORVIA_AGENT_PROVIDER,
    );
