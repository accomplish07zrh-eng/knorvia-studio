...
const MCP_CONFIG_KEY = "knorvia-mcp-config";
export const MCP_DELETED_PRELOAD_KEY = "knorvia-mcp-deleted-preload";

export const DEFAULT_MCP_CONFIG: McpConfig = {
  mcp: { mcpServers: {} },
  knorviaagentmcp: { mcpServers: {}, projects: {} },
};
...
export function makeServerId(
  ...
  const sourceKey =
    source === "knorviaagentmcp" && directorySource && directorySource !== "knorvia"
...
export function buildServerList(
  ...
  existingServers: KnorviaMcpServer[],
): KnorviaMcpServer[] {
  ...
  function makeServer(
    ...
    source: McpSource,
    scope: KnorviaMcpServer["scope"],
    enabledBySource?: boolean,
    projectPath?: string,
    file?: KnorviaMcpServer["file"],
    location?: KnorviaMcpServer["location"],
  ): KnorviaMcpServer {
  ...
  const servers: KnorviaMcpServer[] = [];
...
export function getServerPriority(server: KnorviaMcpServer): number {
