...
const zhCN: Record<string, string> = {
  ...
  "settings.materials.previewTitle": "给下一个灵感留点空间",
  "settings.materials.previewDescription": "静下来，好好想一想。",
  "settings.materials.previewInput": "开始对话…",
  "settings.materials.transparency": "透明度",
  "settings.materials.transparencyHint": "数值越高，背景越明显。",
  ...
  "settings.materials.choose": "选一幅喜欢的风景",
  "settings.materials.formats": "JPG、PNG、WebP · 最大 20 MB",
  "settings.materials.upload": "上传图片",
  "settings.materials.replace": "替换图片",
  "settings.materials.remove": "移除图片",
  "settings.materials.local": "仅保存在此设备，重启后保留，不会发送给模型。大图会适当缩小。",
  "settings.materials.error.tooLarge": "图片超过 20 MB，请选择小一些的图片。",
  "settings.materials.error.invalidImage": "无法读取这张图片，请选择有效的 JPG、PNG 或 WebP。",
  "settings.materials.error.dimensions": "图片超过 4800 万像素，请缩小后再上传。",
  "settings.materials.error.saveFailed": "外观设置未能保存，请检查此设备的可用存储空间后重试。",
  "settings.materials.error.missingImage": "已保存的背景图片无法读取，请重新上传。",
  "settings.materials.error.cleanupFailed": "外观已更新，但旧图片未能清理。请重试移除图片。",
  "chat.metrics.label": "对话统计",
  "chat.metrics.counters": "{rounds} 轮 {steps} 步",
  "chat.metrics.execution": "轮次与生成速度",
  "chat.metrics.executionDetail": "对话轮次；当前轮已完成的模型请求数。",
  "chat.metrics.executionPartial": "轮次为已加载记录的下界；步数为当前轮已完成的模型请求数。",
  "chat.metrics.speedDetail":
    "速度为本轮最近一次模型请求的输出 Token / 实际生成时间，不包含首内容等待与工具执行时间。",
  "chat.metrics.scope.session": "会话累计 Token · 累计缓存命中率",
  "chat.metrics.scope.request": "最近一次模型请求 · 缓存命中率",
  "chat.metrics.scope.turn": "当前轮 Token · 缓存命中率",
  "chat.metrics.scope.reported": "内核上报的用量",
  "chat.metrics.input": "输入（含缓存）",
  "chat.metrics.output": "输出",
  "chat.metrics.cache": "缓存命中",
  ...
  ...agentsZhCN,
  ...workflowZhCN,
  "studio.workflow.parameters": "本次参数",
  "studio.workflow.contentPack": "内容与插图交付包",
  "studio.workflow.contentPackDescription": "串联文案、参考素材、插图与交付清单",
  "studio.workflow.templateParameters": "{count} 个参数",
  "studio.workflow.templateEvidence": "证据规则：未复现的结论标记为未验证",
  "studio.workflow.parameterRequired": "必填",
  "studio.workflow.parameterInvalidNumber": "请输入数字。",
  "studio.workflow.parameterInvalidBoolean": "请输入 true 或 false。",
  "studio.workflow.parameterMissing": "请填写必填参数：{name}。",
  "studio.workflow.outputs": "输出声明",
  "studio.workflow.outputsPlaceholder": "例如 design, notes",
  "studio.workflow.outputsHint": "用英文逗号分隔输出名；下游节点可用 {{ref.名称}} 引用。",
  "studio.workflow.insertOutput": "插入上游输出",
  "studio.workflow.insertOutputNone": "前置节点尚未声明输出",
  "studio.workflow.permission": "执行要求",
  "studio.workflow.permissionInherit": "沿用运行授权",
  "studio.workflow.permissionReadOnly": "只读",
  "studio.workflow.permissionAsk": "询问",
  "studio.workflow.permissionFullAccess": "完全访问",
  ...workflowConflictZhCN,
  ...creationZhCN,
  // T09 创作界面文案：与 messages.ts 的模块目录同属一份 catalog，直接放这里，
  // 免得把模块文件推向 400 行上限（与上面 studio.workflow.* 的既有做法一致）。
  "studio.creation.reuseParameters": "沿用参数",
  "studio.creation.continueAsReference": "作为参考继续生成",
  "studio.creation.variant": "变体",
  "studio.creation.verifyRemote": "核验远端结果",
  "studio.creation.reuseLoaded": "已把该任务的参数与参考图填回输入区；提交时会使用新的生成编号。",
  "studio.creation.disabledActions": "不可用：{items}",
  "studio.creation.entryReasonRunning": "任务仍在进行中，结束后才能复用",
  "studio.creation.entryReasonModelMissing": "原任务的模型已不存在",
  "studio.creation.entryReasonModelDisabled": "原任务的模型已停用",
  "studio.creation.entryReasonModelKind": "原任务的模型类型已变化",
  "studio.creation.entryReasonModelUnconfigured": "原任务的模型尚未配置接口",
  "studio.creation.entryReasonSlotReference": "原模型不再声明参考图槽位",
  "studio.creation.entryReasonSlotFirstFrame": "原模型不再声明首帧槽位",
  "studio.creation.entryReasonSlotLastFrame": "原模型不再声明尾帧槽位",
  "studio.creation.referenceReasonStatus": "只有已完成的任务才能继续作为参考",
  "studio.creation.referenceReasonOutput": "该任务没有可用成果文件",
  "studio.creation.referenceReasonHash": "旧记录缺少成果内容哈希，不能作为参考",
  "studio.creation.referenceReasonKind": "只有图片成果可以作为参考输入",
  "studio.creation.referenceReasonSize": "成果文件超过参考图上限（10 MB）",
  "studio.creation.verifyReasonStatus": "只有结果未知（已中断／已停止）的任务可以核验",
  "studio.creation.verifyReasonModelMissing": "原任务的模型已不存在，无法核验",
  "studio.creation.variantNote": "会用新编号提交同一份参数，可能再次计费",
  "studio.creation.referenceNote": "会用该成果作为参考图提交新任务，可能再次计费",
  "studio.creation.variantUnknownResult": "原结果仍未知；再次提交会产生第二次付费请求",
  "studio.creation.snapshotTitle": "参数快照",
  "studio.creation.snapshotKind": "类型",
  "studio.creation.snapshotModel": "模型",
  "studio.creation.snapshotProtocol": "接口",
  "studio.creation.snapshotProviderModel": "供应商模型",
  "studio.creation.snapshotPrompt": "提示词",
  "studio.creation.snapshotCapturedAt": "记录时间",
  "studio.creation.snapshotReference": "参考图",
  "studio.creation.snapshotFirstFrame": "首帧",
  "studio.creation.snapshotLastFrame": "尾帧",
  "studio.creation.snapshotReconstructible": "可按原参数重建",
  "studio.creation.snapshotNotReconstructible": "无法还原参数",
  "studio.creation.snapshotMissingNote": "该记录缺少参数快照，不会用当前设置替代历史参数。",
  "studio.creation.snapshotMissingFields": "缺失字段：{fields}",
  "studio.creation.detailsSummary": "参数快照与来源",
  "studio.creation.provenanceTitle": "来源关系",
  "studio.creation.provenanceParent": "来源任务",
  "studio.creation.provenanceOutput": "引用成果",
  "studio.creation.provenanceRepeat": "重复的生成编号",
  "studio.creation.verifyOutcomeSucceeded": "远端已确认完成",
  "studio.creation.verifyOutcomeFailed": "远端已确认失败",
  "studio.creation.verifyOutcomeUnknown": "结果仍未知",
  "studio.creation.verifyOutcomeUnsupported": "无法远程验证",
  "studio.creation.checkedAt": "最近核验：{time}",
  "studio.creation.checkedNever": "尚未核验",
  "studio.creation.idempotencyNote":
    "同一次提交会沿用同一个生成编号；修改描述、模型或参考图后才会换新编号。",
  "studio.creation.submissionIdKept": "这次生成编号已保留：{id}。再次提交仍会复用它。",
  "studio.delivery.outcome.produced": "已产出",
  "studio.delivery.outcome.checked": "已核验",
  "studio.delivery.outcome.unverified": "未核验",
  "studio.delivery.outcome.unknown": "结果未知",
  "studio.delivery.restart.applied-refresh-failed": "已应用，但未能重新核验项目文件",
  "studio.delivery.restart.partial-unknown": "部分应用或结果未知",
  "studio.delivery.restart.accepted-later-modified": "已接受版本之后又被修改",
  "studio.delivery.selectAll": "全选可应用文件",
  "studio.delivery.clearSelection": "清空选择",
  "studio.delivery.selectedCount": "已选 {count} 个文件",
  "studio.delivery.batchApply": "应用所选（{count}）",
  "occupationOnboarding.stepMode": "UI 模式",
  "occupationOnboarding.modeTitle": "选择适合你的 UI 模式",
  "occupationOnboarding.modeDescription": "你希望 Knorvia Studio 如何呈现工作过程？",
  ...
  "occupationOnboarding.heroTitle": "一张安静的工作台。",
  "occupationOnboarding.heroDescription": "接上你的模型与 Agent，把对话、流程和创作放在一起。",
  "occupationOnboarding.title": "你的主要工作方向是？",
  "occupationOnboarding.description":
    "选择最接近你日常工作的一项，让 Knorvia Studio 更懂你的工作。",
  ...
  "occupationOnboarding.memoryDescription": "让 Knorvia Studio 记住你的偏好与工作上下文。",
  ...
  "startup.global.silent": "正在启动 Knorvia Studio",
  ...
  "startup.global.servicesFailed":
    "本地数据准备已完成，但应用服务启动失败。请复制诊断信息，退出并重新打开 Knorvia Studio。",
  ...
  "startup.global.starting_services": "正在启动 Knorvia Studio",
  "startup.global.ready": "本地数据已就绪",
  "startup.global.failed": "无法完成启动准备",
  "startup.global.help":
    "准备完成后将自动进入 Knorvia Studio。历史记录较多时可能需要较长时间，请保持应用运行。",
  ...
  "startup.global.error.lock_timeout":
    "等待数据库写锁超时。请检查其他 Knorvia Studio 或 CLI 进程是否仍在更新数据，待其完成后点击重试。",
  "startup.global.error.sql_failed":
    "准备过程未完成。请复制诊断信息查看日志，排除问题后手动重试。应用不会自动重试。",
  "startup.global.error.startup_status_timeout":
    "未能收到启动状态。请退出并重新打开 Knorvia Studio；如果仍失败，请提供诊断信息。",
  "startup.global.error.transport_closed":
    "数据准备进程意外退出或连接中断。请退出并重新打开 Knorvia Studio，应用会重新检查迁移记录。",
  "startup.global.error.unsupported_runtime":
    "当前配置的 Agent 不支持独立存储准备。请恢复配套的 Agent 后重新打开 Knorvia Studio。",
  ...
  "settings.computerUse.disabledToast": "电脑控制已关闭，已有对话需重启 Knorvia Studio 后生效。",
  ...
  "pluginCreator.unavailable": "插件创建器暂不可用。请检查连接，并确认已安装且启用“插件创建器”。",
  ...
  "settings.releaseUpdate.check": "检查更新",
  "settings.releaseUpdate.unconfigured": "尚未配置更新源",
  "settings.releaseUpdate.disabled": "更新检查已关闭",
  "settings.releaseUpdate.current": "已是最新版本",
  "settings.releaseUpdate.noCompatibleRelease": "此更新源仅提供预览版，正式版不会提示安装。",
  "settings.releaseUpdate.available": "发现新版本 {version}，请查看发布信息。",
  "settings.releaseUpdate.failed": "检查失败：{reason}",
  "settings.releaseUpdate.reason.settings": "无法读取设置",
  "settings.releaseUpdate.reason.invalid-source": "更新源地址无效",
  "settings.releaseUpdate.reason.offline": "网络不可用",
  "settings.releaseUpdate.reason.timeout": "请求超时",
  "settings.releaseUpdate.reason.http": "服务器返回错误",
  "settings.releaseUpdate.reason.invalid-response": "发布信息格式无效",
  "settings.releaseUpdate.saveFailed": "保存失败，请检查地址并重试。",
  "settings.releaseUpdate.saveFirst": "请先保存地址，再检查更新。",
  "settings.releaseUpdate.notChecked": "尚未检查",
  ...
  "modelTrajectory.empty": "暂无模型调用记录（仅 Knorvia Studio Agent 会落盘 model-io）",
  ...
  "titleBar.menu.help.about": "关于 Knorvia Studio",
  ...
  "titleBar.menu.help.toggleKnorviaStdioTap": "抓取 Agent stdio 通信",
  ...
  "workspace.openPluginsSettings": "插件",
  ...
  "workspaceSidebar.unavailableLocalDirectory":
    "工作区目录不存在或无法访问，当前仅可查看历史记录。恢复该目录后重启 Knorvia Studio 即可继续使用。",
  ...
  "ssh.assetInstallModeDescription":
    "远端服务器下载可减少上传等待，但服务器需要能访问 Knorvia Studio CDN，并具备下载、解压和校验工具。",
  "ssh.password": "密码",
  ...
  "settings.themeMode.knorvia-light": "浅色",
  "settings.themeMode.knorvia-dark": "深色",
  ...
  "settings.terminalFontFamilyDescription":
    "留空时自动探测系统终端配置；填写后作为 Knorvia Studio 终端的字体覆盖。",
  ...
  "settings.knorviaInteractionBehavior": "交互行为",
  "settings.knorviaInteractionBehaviorDescription":
    "在 Knorvia Studio 运行时将后续操作加入队列，或引导至下一轮工具调用后运行。",
  "settings.knorviaInteractionBehavior.option.queue": "队列",
  "settings.knorviaInteractionBehavior.option.guide": "引导",
  ...
  "settings.dataBaseDirDescription":
    "应用数据的根目录（默认为用户主目录），修改后会将现有数据复制到新位置。路径后缀 .knorvia-studio/v2 不可更改。",
  ...
  "settings.dataBaseDirForbiddenInstallDir":
    "不能选择 Knorvia Studio 安装目录作为数据存储路径。请选择安装目录之外的文件夹。",
  ...
  "sidebar.settings.theme.knorvia-light": "浅色主题",
  "sidebar.settings.theme.knorvia-dark": "深色主题",
  ...
  "settings.migration.sectionDescription":
    "扫描本机 Claude Code 原生历史，可按 workspace 和时间范围筛选，再把选中的会话导入到对应的 Knorvia Studio 任务列表。",
  ...
  "resourceManager.storage.summaryTotal": "Knorvia Studio 总占用",
  ...
  "resourceManager.storage.diskUsage": "Knorvia Studio 占用 {used}",
  ...
  "settings.browser.desktopOnly": "浏览器数据只能在 Knorvia Studio 桌面端管理。",
  ...
  "settings.browser.import.helperVerificationFailed":
    "Knorvia Studio 的 Windows 安全导入组件校验失败，Cookie 未导入。请重新安装或更新 Knorvia Studio。",
  ...
  "settings.browser.import.adminConfirmDescription":
    "Chrome 在 Windows 上使用 App-Bound 加密保护 Cookie。Knorvia Studio 将为本次导入请求管理员权限，临时启动系统服务，完成后立即删除。不会读取或导入 Chrome 密码。",
  ...
  "settings.mcp.description": "管理 Knorvia Studio Agent 使用的 MCP 服务器配置。",
  ...
  "settings.mcp.host.activeDescription":
    "该 MCP 服务器由 Knorvia Studio 宿主为 {pluginName} 插件提供，运行时身份由宿主管理。",
  ...
  "settings.mcp.statusOnlyUnsupported":
    "当前 Knorvia Studio Agent 不支持 OAuth 状态刷新。请升级或重启 Knorvia Studio，然后重新打开 MCP 设置进行完整刷新。",
  ...
  "settings.mcp.failure.not_authenticated": "此 MCP 服务器尚未完成授权，请检查连接配置。",
  "settings.mcp.failure.coding_plan_required": "MCP 服务暂不可用，请检查服务器和供应商连接配置。",
  ...
  "settings.mcpServers.import.importing": "正在导入 MCP 服务器到 Knorvia Studio",
  ...
  "settings.modelProvider.namePlaceholder": "如：我的模型服务",
  ...
  "settings.modelProvider.help.contextWindow":
    "模型一次可处理的上下文容量，单位为 Token。Knorvia Studio 会据此管理上下文。\n请勿超过模型的实际上限。",
  ...
  "settings.modelProvider.help.followRecommendedConfig":
    "根据模型 ID、Base URL 和 API 格式，为您智能匹配推荐配置。Knorvia Studio 会持续更新推荐配置，并自动同步给您。\n如果手动修改某项配置，该项将转为手动管理，不再跟随推荐更新；其他配置仍由智能配置管理。",
  ...
  "settings.modelProvider.presetDescription": "支持手动配置供应商地址、API Key 和模型。",
  "settings.modelProvider.presetEmpty": "尚未配置模型，请添加供应商。",
  ...
  "settings.usage.billingBanner.description":
    "连接 {provider} 账号后查询编程套餐权益，购买或配置后回到 Knorvia Studio 即可继续编码。",
  ...
  "sidebar.usage.plan.knorviaMcpDescription": "Knorvia Studio 预置插件 MCP 每日合计额度",
  ...
  "settings.skills.import.mode.copy.description":
    "将完整技能目录复制到 Knorvia Studio。外部 Agent 目录后续变更不会自动同步。",
  "settings.skills.import.mode.symlink.description":
    "创建指向外部 Agent 技能目录的链接。Knorvia Studio 会跟随来源目录后续变更，但该技能依赖来源路径持续可用。",
  "settings.skills.import.importing": "正在导入技能到 Knorvia Studio",
  ...
  "settings.subagents.description":
    "管理 Knorvia Studio Agent 运行时消费的用户级子智能体 Markdown 文件。",
  ...
  "settings.plugins.store.subtitle": "用插件为 Knorvia Studio 扩展技能、命令与 MCP 能力",
  ...
  "settings.plugins.sources.button": "来源",
  "settings.plugins.sources.title": "插件来源",
  "settings.plugins.sources.description":
    "在当前主机添加包含 marketplace.json 的目录，并在这里安装其中的插件。",
  "settings.plugins.sources.placeholder": "插件来源目录或 URL",
  "settings.plugins.sources.add": "添加来源",
  "settings.plugins.sources.empty": "暂无个人来源。内置插件已自动安装。",
  "settings.plugins.sources.available": "可安装的插件",
  "settings.plugins.sources.confirmRemove": "确认移除",
  "settings.plugins.sources.refreshed": "来源已刷新",
  "settings.plugins.sources.installed": "插件已安装",
  ...
  "settings.plugins.import.mode.copy.description":
    "将完整插件目录复制到 Knorvia Studio，并注册到 plugins.dirs。外部 Agent 目录后续变更不会自动同步。",
  "settings.plugins.import.mode.symlink.description":
    "创建指向外部 Agent 插件目录的链接，并注册到 plugins.dirs。Knorvia Studio 会跟随来源目录后续变更，但该插件依赖来源路径持续可用。",
  "settings.plugins.import.importing": "正在导入插件到 Knorvia Studio",
  ...
  "settings.commands.description":
    "管理 Knorvia Studio Agent 的 .md 命令文件。命令可通过 /command-name 在聊天中调用。",
  ...
  "settings.commands.import.mode.copy.description":
    "将命令文件复制到 Knorvia Studio。外部 Agent 文件后续变更不会自动同步。",
  "settings.commands.import.mode.symlink.description":
    "创建指向外部 Agent 命令文件的链接。Knorvia Studio 会跟随来源文件后续变更，但该命令依赖来源路径持续可用。",
  "settings.commands.import.importing": "正在导入命令到 Knorvia Studio",
  ...
  "settings.workspaceFileSearch.description":
    "编辑 .knorviaignore 忽略规则（语法与 .gitignore 一致），控制工作区文件搜索的范围。保存后下次搜索生效。",
  "settings.workspaceFileSearch.templateHint":
    ".knorviaignore 尚未创建：下方为初始内容预览（.gitignore 拷贝 + 默认排除规则），保存后才会写入工作区。",
  ...
  "settings.workspaceFileSearch.revealHint": "保存后即可在工作区根目录找到 .knorviaignore",
  ...
  "settingsSync.discovery.helper": "仅导入缺失项，不会覆盖当前 Knorvia Studio 中已存在的配置。",
  ...
  "onboarding.dialog.title": "欢迎使用 Knorvia Studio",
  ...
  "studio.firstRun.cliHint": "仅列出本机已检测到的安装，选择后进入对应对话。",
  "studio.firstRun.cliCaveat": "检测到安装不代表已经登录或拥有可用额度。",
  "studio.firstRun.checking": "正在检测本机 CLI…",
  "studio.firstRun.checkFailed": "检测失败，请稍后在 Agent 管理中重试。",
  "studio.firstRun.noneFound": "未检测到可用的本机 CLI。",
  "studio.firstRun.later": "稍后再说",
  "studio.firstRun.laterHint": "先进入工作区，不配置供应商或 CLI。",
  ...
  "settings.localDiagnostics.error": "诊断信息处理失败或预览已过期，请重新预览。",
  "settings.localDiagnostics.saved": "已保存",
  ...
  "onboarding.stepDescription.migration": "开始迁移并等待 Knorvia Studio 完成导入。",
  ...
  "onboarding.agentsFile.confirmDescription":
    "将从 {source} 复制到 {target}。\n如果目标文件已存在，Knorvia Studio 默认 AGENTS 配置会被覆盖。",
  ...
  "chat.placeholder.newTask": "向 Knorvia Studio 提问，使用 @ 添加上下文，使用 / 选择命令或能力",
  "chat.placeholder.newTaskMobile": "向 Knorvia Studio 提问…",
  ...
  "chat.toolbar.computerUse.tooltip.ready": "电脑操作已就绪 · 直接描述你想让 Knorvia Studio 做的事",
  "chat.toolbar.computerUse.tooltip.permissionRequired": "缺少 macOS 权限，点击完成授权",
  "chat.toolbar.computerUse.tooltip.error":
    "电脑操作启用失败 · 重启 Knorvia Studio 应用后重试，或让 Knorvia Studio 排查日志",
  ...
  "workflows.hub.empty.hint":
    "在对话里让 Knorvia Studio 设计工作流，跑通之后再让它保存到项目里。未打开的项目不会出现在这里。",
  ...
  "workflows.hub.detail.whenToUse.help": "给 Knorvia Studio 的路由提示：什么场景该选这个工作流。",
  ...
  "workflows.hub.detail.script.note":
    "脚本只读。要改脚本，在对话里让 Knorvia Studio 修订后另存一版。",
  ...
  "chat.error.noAvailableModel": "当前没有可用模型。请在模型设置中添加供应商和模型。",
  "chat.error.sendFailed": "发送失败，请稍后重试。",
  "chat.error.modelSettings": "模型设置",
  "chat.error.setModels": "配置",
  "chat.quota.mcp.quotaExhausted": "Knorvia Studio MCP「{server}」今日额度已用完，明天自动恢复。",
  "chat.quota.mcp.codingPlanRequired":
    "当前无 Knorvia Studio MCP「{server}」额度，请登录或开通 Coding Plan 使用。",
  ...
  // 模式
  "mode.plan": "计划",
  "mode.label.knorvia.build": "变更前确认",
  "mode.label.knorvia.edit": "自动编辑",
  "mode.label.knorvia.plan": "计划模式",
  "mode.label.knorvia.yolo": "完全访问",
  "mode.description.knorvia.build": "改文件前先问我。",
  "mode.description.knorvia.edit": "自动编辑文件。",
  "mode.description.knorvia.plan": "编辑前先出计划。",
  "mode.description.knorvia.yolo": "减少确认次数。",
  "todo.panel.title": "待办",
  ...
  // Knorvia Agent
  "knorvia.unavailable": "AI 代理不可用",
  "knorvia.initFailed": "启动 AI 代理失败",
  "knorvia.error.TASK_OWNED_BY_OTHER_HOST": "该任务正在另一个已连接视图中运行。",
  "knorvia.error.STALE_TASK_OWNER_COMMAND": "该操作属于旧的运行轮次，已忽略。",
  "knorvia.error.NO_ACTIVE_TASK_OWNER": "当前没有可处理该操作的任务所有者。",
  "knorvia.error.OWNER_COMMAND_FAILED": "任务所有者未能完成该操作。",
  ...
  "knorvia.error.providerBusiness.1006": "模型服务鉴权已失效，请检查供应商配置和 API Key。",
  "knorvia.error.providerBusiness.1005":
    "已达到模型供应商的用量限制。请检查供应商用量，或切换模型后重试。",
  "knorvia.error.providerBusiness.3006": "当前模型不在可用范围内，请切换到允许的模型后重试。",
  "knorvia.error.providerBusiness.3002": "请求过于频繁，请稍后重试。",
  "knorvia.error.providerBusiness.3001": "请求参数错误，请检查输入后重试。",
  "knorvia.error.providerBusiness.3007": "请求被网关安全校验拒绝，请稍后重试或联系支持。",
  "knorvia.error.providerBusiness.3008": "当前模型服务繁忙，请切换模型或稍后再试。",
  "knorvia.error.providerBusiness.3009": "当前模型服务繁忙，请切换模型或稍后再试。",
  "knorvia.error.providerBusiness.3010": "当前模型服务繁忙，请切换模型或稍后再试。",
  "knorvia.error.providerBusiness.3102": "已超过单次最长运行时间，请重新发起任务继续。",
  "knorvia.error.modelSuspiciousEmpty": "模型未返回任何内容。",
  "knorvia.error.providerBusiness.2007": "上游服务暂时不可用，请稍后重试。",
  "knorvia.error.providerBusiness.429": "请求过于频繁，请稍后重试。",
  ...
  "feedback.submit.template.section.copyErrorHeading": "Knorvia Studio 报错信息",
  // 表单通用
  ...
  "offPeak.keepAwakeBanner": "Knorvia Studio 运行会话时保持电脑唤醒。",
  ...
  "offPeak.form.instructionsPlaceholder":
    "描述希望 Knorvia Studio 在后台完成的工作、预期结果和约束，例如整理本周代码改动并生成站会摘要…",
  ...
  "automations.runs.status.interrupted": "已中断，结果需检查",
  "automations.studioWorkflow": "Studio 工作流按节点配置内核",
  "automations.studioWorkflowBadge": "Studio 工作流",
  ...
  "chat.cuaReadiness.toolsNotLoaded":
    "Knorvia Studio 电脑控制仍在准备中——工具尚未加载（已加载 {count} 个）。请先授予下方权限，Helper 就绪后工具会自动出现。",
  "chat.cuaReadiness.toolsPreparing":
    "Knorvia Studio 电脑控制仍在准备中——工具尚未加载。请先授予下方权限，Helper 就绪后工具会自动出现。",
  ...
  "cuaPermission.modal.relaunchAppButton": "重启 Knorvia Studio",
  "cuaPermission.modal.relaunchAppHint":
    "重启 Helper 后仍未生效？重启 Knorvia Studio 可彻底重载 Helper 进程。",
  ...
  "cuaPermission.tools.untrustedRuntime":
    "检测到电脑控制工具，但它们并非来自已校验的 Knorvia Studio 官方插件。请检查插件安装后重新验证。",
  ...
  "cuaPermission.ready.sessionValidationHint":
    "首个会话启动时，Knorvia Studio 会针对该会话精确验证电脑控制工具。",
