...
const enUS: Record<string, string> = {
  ...
  "settings.materials.previewTitle": "Leave room for your next idea",
  "settings.materials.previewDescription": "Take a moment to think.",
  "settings.materials.previewInput": "Start a conversation…",
  "settings.materials.transparency": "Transparency",
  ...
  "chat.metrics.executionDetail":
    "Conversation rounds; completed model requests in the current round.",
  "chat.metrics.executionPartial":
    "Rounds are a lower bound from loaded history; steps are completed model requests in the current round.",
  "chat.metrics.speedDetail":
    "Speed uses the latest request's output tokens divided by generation time, excluding first-content latency and tool execution.",
  "chat.metrics.scope.session": "Session tokens · cumulative cache hit rate",
  "chat.metrics.scope.request": "Latest model request · cache hit rate",
  "chat.metrics.scope.turn": "Current turn tokens · cache hit rate",
  "chat.metrics.scope.reported": "Usage reported by the kernel",
  "chat.metrics.input": "Input (including cache)",
  "chat.metrics.output": "Output",
  "chat.metrics.cache": "Cache hit",
  ...
  "studio.workflow.parameterMissing": "Fill in the required parameter: {name}.",
  "studio.workflow.outputs": "Declared outputs",
  "studio.workflow.outputsPlaceholder": "e.g. design, notes",
  "studio.workflow.outputsHint":
    "Separate output names with commas; downstream nodes can reference them as {{ref.name}}.",
  "studio.workflow.insertOutput": "Insert upstream output",
  "studio.workflow.insertOutputNone": "No predecessor declares an output yet",
  "studio.workflow.permission": "Execution requirement",
  "studio.workflow.permissionInherit": "Use the run authorisation",
  "studio.workflow.permissionReadOnly": "Read-only",
  "studio.workflow.permissionAsk": "Ask",
  ...
  "studio.delivery.outcome.unknown": "Unknown result",
  "studio.delivery.restart.applied-refresh-failed":
    "Applied, but the project files could not be verified",
  "studio.delivery.restart.partial-unknown": "Partially applied or unknown result",
  "studio.delivery.restart.accepted-later-modified": "Modified after the accepted version",
  "studio.delivery.selectAll": "Select applicable files",
  "studio.delivery.clearSelection": "Clear selection",
  "studio.delivery.selectedCount": "{count} selected",
  "studio.delivery.batchApply": "Apply selected ({count})",
  "occupationOnboarding.stepMode": "UI mode",
  "occupationOnboarding.modeTitle": "Choose your UI mode",
  "occupationOnboarding.modeDescription": "How would you like Knorvia Studio to show its work?",
  ...
  "chat.plugins.manage": "Manage plugins",
  ...
  "occupationOnboarding.heroTitle": "A quiet desk for your agents.",
  "occupationOnboarding.heroDescription":
    "Connect your models and agents.\nKeep chats, workflows and creations in one place.",
  ...
  "occupationOnboarding.memoryDescription":
    "Let Knorvia Studio remember your preferences and work context.",
  ...
  "startup.global.silent": "Starting Knorvia Studio",
  ...
  "startup.global.servicesFailed":
    "Local data is ready, but app services failed to start. Copy the diagnostics, then exit and reopen Knorvia Studio.",
  ...
  "startup.global.starting_services": "Starting Knorvia Studio",
  "startup.global.ready": "Local data is ready",
  "startup.global.failed": "Startup preparation failed",
  "startup.global.help":
    "Knorvia Studio will open when preparation finishes. Large histories may take longer. Please keep the app running.",
  ...
  "startup.global.error.lock_timeout":
    "Waiting for the database write lock timed out. Another Knorvia Studio or CLI process may be updating data. Retry after it finishes.",
  ...
  "startup.global.error.startup_status_timeout":
    "No startup status was received. Exit and reopen Knorvia Studio. If it fails again, provide the diagnostics to support.",
  "startup.global.error.transport_closed":
    "The preparation process exited or disconnected. Exit and reopen Knorvia Studio to check the migration records again.",
  "startup.global.error.unsupported_runtime":
    "The configured Agent does not support storage preparation. Restore the bundled Agent, then reopen Knorvia Studio.",
  ...
  "settings.computerUse.disabledToast":
    "Computer Use is disabled. Existing conversations require a Knorvia Studio restart to take effect.",
  ...
  "pluginCreator.unavailable":
    "Plugin Creator is unavailable. Check the connection and make sure Plugin Creator is installed and enabled.",
  ...
  "settings.releaseUpdate.reason.offline": "Network unavailable",
  "settings.releaseUpdate.reason.timeout": "Request timed out",
  "settings.releaseUpdate.reason.http": "Server returned an error",
  "settings.releaseUpdate.reason.invalid-response": "Invalid release information",
  "settings.releaseUpdate.saveFailed": "Could not save. Check the URL and try again.",
  "settings.releaseUpdate.saveFirst": "Save the URL before checking.",
  "settings.releaseUpdate.notChecked": "Not checked yet",
  ...
  "modelTrajectory.empty": "No model calls recorded (only Knorvia Studio Agent writes model-io)",
  ...
  "titleBar.menu.help.about": "About Knorvia Studio",
  ...
  "titleBar.menu.help.toggleKnorviaStdioTap": "Capture agent stdio traffic",
  ...
  "workspace.openPluginsSettings": "Plugins",
  ...
  "workspaceSidebar.unavailableLocalDirectory":
    "The workspace directory does not exist or cannot be accessed. You can only view history for now. Restore the directory and restart Knorvia Studio to continue.",
  ...
  "ssh.assetInstallModeDescription":
    "Remote server download reduces upload waiting, but the server must reach the Knorvia Studio CDN and have download, extract, and checksum tools.",
  ...
  "chat.changeSummary.rewindDialog.description":
    "Knorvia Studio checks current file content again before writing. If another process changed a file, no files will be written.",
  ...
  "settings.themeMode.knorvia-light": "Light",
  "settings.themeMode.knorvia-dark": "Dark",
  ...
  "settings.terminalFontFamilyDescription":
    "Leave blank to auto-detect system terminal settings; set a value to override the Knorvia Studio terminal font.",
  ...
  "settings.knorviaInteractionBehavior": "Interaction behavior",
  "settings.knorviaInteractionBehaviorDescription":
    "While Knorvia Studio is running, add follow-up actions to the queue or guide them to run after the next tool call.",
  "settings.knorviaInteractionBehavior.option.queue": "Queue",
  "settings.knorviaInteractionBehavior.option.guide": "Guide",
  ...
  "settings.dataBaseDirDescription":
    "Root directory for app data (defaults to user home directory). Existing data will be copied to the new location. The .knorvia-studio/v2 suffix cannot be changed.",
  ...
  "settings.dataBaseDirForbiddenInstallDir":
    "The data directory cannot be the Knorvia Studio installation folder on Windows. Choose a folder outside the app install location.",
  ...
  "sidebar.settings.theme.knorvia-light": "Light theme",
  "sidebar.settings.theme.knorvia-dark": "Dark theme",
  ...
  "settings.migration.sectionDescription":
    "Scan native Claude Code history on this machine, optionally filter by workspace and activity window, then import the selected sessions into their matching Knorvia Studio task lists.",
  ...
  "resourceManager.storage.summaryTotal": "Total used by Knorvia Studio",
  ...
  "resourceManager.storage.diskUsage": "Knorvia Studio uses {used}",
  ...
  "settings.browser.desktopOnly":
    "Browser data can only be managed in the Knorvia Studio desktop app.",
  ...
  "settings.browser.import.helperVerificationFailed":
    "Knorvia Studio could not verify its Windows secure import component. Reinstall or update Knorvia Studio before importing cookies.",
  ...
  "settings.browser.import.adminConfirmDescription":
    "Chrome protects cookies with App-Bound encryption on Windows. For this import only, Knorvia Studio will request administrator access, start a temporary system service, and delete it immediately afterward. Chrome passwords are never read or imported.",
  ...
  "settings.mcp.description": "Manage MCP server configurations used by Knorvia Studio Agent.",
  ...
  "settings.mcp.host.activeDescription":
    "Knorvia Studio provides this MCP server for the {pluginName} plugin. Its runtime identity is managed by the host.",
  ...
  "settings.mcp.statusOnlyUnsupported":
    "This Knorvia Studio Agent cannot refresh OAuth status. Upgrade or restart Knorvia Studio, then reopen MCP settings to run a full refresh.",
  ...
  "settings.mcp.failure.not_authenticated":
    "This MCP server requires authorization. Check its connection settings.",
  "settings.mcp.failure.coding_plan_required":
    "The MCP service is unavailable. Check the server and provider connection settings.",
  ...
  "settings.mcpServers.import.importing": "Importing MCP servers into Knorvia Studio",
  ...
  "settings.modelProvider.namePlaceholder": "e.g. My model service",
  ...
  "settings.modelProvider.help.contextWindow":
    "The context capacity the model can process at once, in tokens. Knorvia Studio uses this to manage context.\nDo not exceed the model's actual limit.",
  ...
  "settings.usage.billingBanner.description":
    "Connect your {provider} account to query Coding Plan entitlement, then keep coding in Knorvia Studio after purchase or setup.",
  ...
  "settings.usage.entitlementServerMcpUsage": "Knorvia Studio MCP",
  ...
  "sidebar.usage.plan.mcp": "Knorvia Studio MCP",
  "sidebar.usage.plan.knorviaMcp": "Knorvia Studio MCP",
  "sidebar.usage.plan.knorviaMcpDescription":
    "Daily aggregate quota for Knorvia Studio built-in plugin MCPs",
  ...
  "settings.modelProvider.presetDescription":
    "Configure a provider URL, API key, and model manually.",
  "settings.modelProvider.presetEmpty": "No model configured. Add a provider to continue.",
  ...
  "settings.skills.import.mode.copy.description":
    "Copy the full skill directory into Knorvia Studio. Later changes in the external agent directory will not sync automatically.",
  "settings.skills.import.mode.symlink.description":
    "Create a directory link to the external agent skill. Knorvia Studio follows later source changes, but the skill depends on that source path remaining available.",
  "settings.skills.import.importing": "Importing skills into Knorvia Studio",
  ...
  "settings.subagents.description":
    "Manage user-level subagent Markdown files consumed by Knorvia Studio Agent.",
  ...
  "settings.plugin.plugins.emptyInstalledDescription":
    "Installed plugins appear here for configuration, enabling, updates, and removal.",
  ...
  "settings.plugins.store.subtitle":
    "Extend Knorvia Studio with skills, commands, and MCP servers from plugins",
  ...
  "settings.plugins.sources.button": "Sources",
  "settings.plugins.sources.title": "Plugin sources",
  "settings.plugins.sources.description":
    "Add a directory containing marketplace.json on this host, then install its plugins here.",
  "settings.plugins.sources.placeholder": "Plugin source directory or URL",
  "settings.plugins.sources.add": "Add source",
  "settings.plugins.sources.empty": "No personal sources. Bundled plugins are already installed.",
  "settings.plugins.sources.available": "Available to install",
  "settings.plugins.sources.confirmRemove": "Confirm remove",
  "settings.plugins.sources.refreshed": "Source refreshed",
  "settings.plugins.sources.installed": "Plugin installed",
  ...
  "settings.plugins.import.mode.copy.description":
    "Copy the full plugin directory into Knorvia Studio and register it in plugins.dirs. Later changes in the external agent directory will not sync automatically.",
  "settings.plugins.import.mode.symlink.description":
    "Create a directory link to the external agent plugin and register it in plugins.dirs. Knorvia Studio follows later source changes, but the plugin depends on that source path remaining available.",
  "settings.plugins.import.importing": "Importing plugins into Knorvia Studio",
  ...
  "settings.commands.description":
    "Manage Knorvia Studio Agent .md command files. Commands can be invoked with /command-name in chat.",
  "settings.commands.sourceFilterLabel": "Source filter",
  "settings.commands.source.agent": "Knorvia Studio Agent",
  ...
  "settings.commands.import.mode.copy.description":
    "Copy the command file into Knorvia Studio. Later changes in the external agent file will not sync automatically.",
  "settings.commands.import.mode.symlink.description":
    "Create a file link to the external agent command. Knorvia Studio follows later source changes, but the command depends on that source path remaining available.",
  "settings.commands.import.importing": "Importing commands into Knorvia Studio",
  ...
  "settings.workspaceFileSearch.description":
    "Edit .knorviaignore rules (gitignore syntax) that scope workspace file search. Takes effect on the next search after saving.",
  "settings.workspaceFileSearch.templateHint":
    ".knorviaignore does not exist yet: the content below is the initial preview (.gitignore copy + default exclusions); it is written to the workspace only after saving.",
  ...
  "settings.workspaceFileSearch.revealHint":
    "Save first; .knorviaignore lives at the workspace root",
  ...
  "settingsSync.action.finish": "Start using Knorvia Studio",
  "settingsSync.agent.knorvia": "Knorvia Studio Agent",
  ...
  "settingsSync.discovery.helper":
    "Only missing items will be imported and your current Knorvia Studio settings will not be overwritten.",
  ...
  "onboarding.dialog.title": "Welcome to Knorvia Studio",
  ...
  "studio.firstRun.noneFound": "No local CLI installation was detected.",
  "studio.firstRun.later": "Maybe later",
  "studio.firstRun.laterHint": "Enter the workspace without configuring a provider or CLI.",
  ...
  "onboarding.stepDescription.migration":
    "Start migration and wait while Knorvia Studio imports your selections.",
  ...
  "onboarding.agentsFile.confirmDescription":
    "Knorvia Studio will copy {source} to {target}.\nIf the target file already exists, the Knorvia Studio default AGENTS configuration will be overwritten.",
  ...
  "chat.placeholder.newTask":
    "Ask Knorvia Studio anything, @ to add context, / for commands or capabilities",
  "chat.placeholder.newTaskMobile": "Ask Knorvia Studio anything…",
  ...
  "chat.modelSwitch.contextWindowGuard.description":
    "This conversation has used {used} tokens, which exceeds {modelName}'s available context of {target} tokens after reserving maximum output.\nCompress the current conversation with the current model first. If the compressed context fits, Knorvia Studio will continue switching models.",
  ...
  "chat.toolbar.computerUse.tooltip.ready":
    "Computer Use ready — just describe what you want Knorvia Studio to do",
  ...
  "chat.toolbar.computerUse.tooltip.error":
    "Computer Use enablement failed. Please restart Knorvia Studio app and retry, or ask Knorvia Studio to investigate the logs",
  ...
  "workflows.hub.empty.hint":
    "Design a workflow with Knorvia Studio in chat, then have it save the workflow to a project once it works. Projects that aren't open don't appear here.",
  ...
  "workflows.hub.detail.whenToUse.help":
    "A routing hint for Knorvia Studio: when this workflow is the right pick.",
  ...
  "workflows.hub.detail.script.note":
    "The script is read-only. To change it, revise it with Knorvia Studio in chat and save a new version.",
  ...
  "chat.slash.emptyUnavailable":
    "No slash commands have been broadcast for the current Knorvia Studio Agent session",
  ...
  "chat.error.noAvailableModel": "No model available. Add a provider and model in Model settings.",
  ...
  "chat.quota.mcp.quotaExhausted":
    'Knorvia Studio MCP "{server}" has used up today\'s quota. It resets tomorrow.',
  "chat.quota.mcp.codingPlanRequired":
    'No Knorvia Studio MCP "{server}" quota. Sign in or get a Coding Plan to use it.',
  ...
  // Modes
  "mode.plan": "Plan",
  "mode.label.knorvia.build": "Ask before changes",
  "mode.label.knorvia.edit": "Edit automatically",
  "mode.label.knorvia.plan": "Plan mode",
  "mode.label.knorvia.yolo": "Full access",
  "mode.description.knorvia.build": "Ask before file changes.",
  "mode.description.knorvia.edit": "Edit files automatically.",
  "mode.description.knorvia.plan": "Plan before editing.",
  "mode.description.knorvia.yolo": "Run with fewer confirmations.",
  ...
  "knorvia.error.MEDIA_BUDGET_CURRENT_ATTACHMENT_TOO_LARGE":
    "Current attachments are too large for one request. Remove or compress attachments and try again.",
  "knorvia.error.MEDIA_BUDGET_CURRENT_IMAGE_TOO_LARGE":
    "Current image attachments are too large. Remove or compress images and try again.",
  "knorvia.error.MEDIA_BUDGET_CURRENT_VIDEO_TOO_LARGE":
    "Current video attachments are too large. Remove or compress videos and try again.",
  "knorvia.error.KNORVIA_RUNTIME_MODEL_UNAVAILABLE":
    "The current model is no longer available. Select an available model from the current model list to continue.",
  "knorvia.error.KNORVIA_BIGMODEL_TEAM_PLAN_MEMBER_REQUIRED":
    "The current model is unavailable. Check whether the current account has been added to the project member list.",
  "knorvia.error.providerBusiness.1006":
    "Model service authentication has expired. Check the provider configuration and API key.",
  "knorvia.error.providerBusiness.1005":
    "The model provider usage limit has been reached. Check provider usage or switch models and retry.",
  "knorvia.error.providerBusiness.3006":
    "The current model is not included in this plan. Switch to an allowed model and try again.",
  "knorvia.error.providerBusiness.3002":
    "You're sending requests too quickly. Please try again later.",
  "knorvia.error.providerBusiness.3001":
    "The request parameters are invalid. Check the input and try again.",
  "knorvia.error.providerBusiness.3007":
    "The request was rejected by the gateway security check. Please try again later or contact support.",
  "knorvia.error.providerBusiness.3008":
    "The model service is busy. Switch models or try again later.",
  "knorvia.error.providerBusiness.3009":
    "The model service is busy. Switch models or try again later.",
  "knorvia.error.providerBusiness.3010":
    "The model service is busy. Switch models or try again later.",
  "knorvia.error.providerBusiness.3102":
    "The maximum run time was reached. Start a new task to continue.",
  "knorvia.error.modelSuspiciousEmpty":
    "The model returned no content (often caused by an expired token or plan issues). Please send again.",
  "knorvia.error.providerBusiness.2007":
    "The upstream service is temporarily unavailable. Please try again later.",
  "knorvia.error.providerBusiness.429":
    "You're sending requests too quickly. Please try again later.",
  ...
  "resourceManager.appUsage": "Knorvia Studio",
  ...
  "feedback.submit.template.section.copyErrorHeading": "Knorvia Studio Error Info",
  // Forms
  ...
  "offPeak.keepAwakeBanner": "Keep your computer awake while Knorvia Studio is running a chat.",
  ...
  "offPeak.form.instructionsPlaceholder":
    "Describe a task Knorvia Studio can work on in the background, including the expected result and any constraints…",
  ...
  "chat.cuaReadiness.toolsNotLoaded":
    "Knorvia Studio Computer Use is still preparing — its tools aren't loaded yet ({count} loaded). Grant the permissions below; tools appear once the helper is ready.",
  "chat.cuaReadiness.toolsPreparing":
    "Knorvia Studio Computer Use is still preparing — its tools aren't loaded yet. Grant the permissions below; tools appear once the helper is ready.",
  ...
  "cuaPermission.modal.relaunchAppButton": "Restart Knorvia Studio",
  "cuaPermission.modal.relaunchAppHint":
    "Still not working after restarting Helper? Restart Knorvia Studio to fully reload the Helper process.",
  ...
  "cuaPermission.tools.untrustedRuntime":
    "Computer Use tools were found, but they did not come from the verified Knorvia Studio plugin. Review the plugin installation, then check again.",
  ...
  "cuaPermission.ready.sessionValidationHint":
    "Knorvia Studio will verify the Computer Use tools against the exact session when your first session starts.",
