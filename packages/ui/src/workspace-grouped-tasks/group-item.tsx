...
import type { KnorviaGroupedTaskViewNode, KnorviaTaskGroupColor } from "@knorvia/services";
import {
...
export function GroupItem({
  ...
  getTaskRemoteSessionId: (task: KnorviaTaskMeta) => string | undefined;
  getTaskWorkspaceLabel: (task: KnorviaTaskMeta) => string;
  onSelectTask: (workspacePath: string, taskId: string, workspaceIdentity?: string) => void;
  onCloseTask: (task: KnorviaTaskMeta) => void;
  onOpenFileTree?: (task: KnorviaTaskMeta) => void;
  onCreateTask: () => void;
  ...
  onUpdateGroupColor: (groupId: string, color: KnorviaTaskGroupColor) => void;
  onUngroupGroup: (groupId: string) => void;
  onMoveTaskToGroup: (task: KnorviaTaskMeta, groupId: string | null) => void;
  onMoveTaskToTop: (task: KnorviaTaskMeta) => void;
  onStartRenameTask: (task: KnorviaTaskMeta) => void;
  onArchiveTask: (task: KnorviaTaskMeta) => void;
  onMarkTaskAsUnread: (task: KnorviaTaskMeta) => void;
  ...
  const handleGroupColorChange = useCallback(
    (color: string) => {
      onUpdateGroupColor(node.group.id, color as KnorviaTaskGroupColor);
    },
