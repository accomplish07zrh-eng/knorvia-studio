import type { KnorviaTaskGroupColor } from "@knorvia/services";
...
const TASK_GROUP_COLOR_CLASS: Record<KnorviaTaskGroupColor, string> = {
...
const TASK_GROUP_BORDER_COLOR_CLASS: Record<KnorviaTaskGroupColor, string> = {
