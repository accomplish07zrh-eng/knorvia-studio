...
import { unpackWorkspaceFileEntries } from "@knorvia/shared/workspaceFileEntriesCodec";
...
type TaskSearchResultItem = KnorviaTaskMeta & {
  searchSnippet?: string;
  searchSnippets?: string[];
};
type TaskChangedFileSummary = KnorviaTaskChangeSummary["files"][number];
...
function getTaskTitle(task: KnorviaTaskMeta, untitledLabel: string): string {
