            ...
            <DropdownMenuSub>
              ...
              <DropdownMenuSubContent className="w-48">
                <DropdownMenuRadioGroup value={theme} onValueChange={onThemeChange}>
                  ...
                  <DropdownMenuRadioItem value="knorvia-dark">
                    {intl.formatMessage({
                      id: "sidebar.settings.theme.knorvia-dark",
                    })}
                  </DropdownMenuRadioItem>
                  <DropdownMenuRadioItem value="knorvia-light">
                    {intl.formatMessage({
                      id: "sidebar.settings.theme.knorvia-light",
                    })}
                  </DropdownMenuRadioItem>
                </DropdownMenuRadioGroup>
              </DropdownMenuSubContent>
