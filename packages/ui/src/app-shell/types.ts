...
import type { WorkspaceKnorviaUIState } from "@/store/sessionStore.js";
import type {
...
import type {
  ...
  KnorviaProvider,
  KnorviaTaskMeta,
  KnorviaTaskRuntimeStatus,
} from "@knorvia/shared";
import type { RefObject } from "react";
import type { StudioNavigation } from "@/studio/useStudioNavigation.js";

export interface WorkspaceShellKnorviaState {
  activeTaskId: WorkspaceKnorviaUIState["activeTaskId"];
  draftFocusVersion: WorkspaceKnorviaUIState["draftFocusVersion"];
  modelSwitchPending: WorkspaceKnorviaUIState["modelSwitchPending"];
  modelSwitchStage: WorkspaceKnorviaUIState["modelSwitchStage"];
  selectedProvider: WorkspaceKnorviaUIState["selectedProvider"];
  optimisticTaskListByTaskId: WorkspaceKnorviaUIState["optimisticTaskListByTaskId"];
  workspaceInit: WorkspaceKnorviaUIState["workspaceInit"];
...
export interface WorkspaceShellLayoutProps extends AppProps {
  ...
  workspaceTabs: Array<{
    ...
    remoteTarget?: import("@knorvia/shared").RemoteTarget;
    workspaceIdentity?: string;
