...
import { createUuid, type RemoteTarget, type RemoteWorkspaceSessionEntry } from "@knorvia/shared";
import {
                ...
                {currentStep === "directory" ? (
                  <div data-testid={TID_SSH_SUCCESS} className="h-full">
                    <RemoteConnectionDirectoryStep
                      ...
                      remoteKnorviaAgentService={directoryBrowserServices?.agentService ?? null}
