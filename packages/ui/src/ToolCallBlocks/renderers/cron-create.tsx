...
import { TID_CRON_CREATE_CARD, TID_CRON_CREATE_OPEN } from "@knorvia/shared";
...
function isScheduleRule(value: unknown): value is KnorviaAutomationScheduleRule {
...
function readCronCreateAutomationOutputSummary(value: unknown): CronCreateAutomationSummary | null {
  ...
  const scheduleRule = isScheduleRule(automation.scheduleRule)
    ? (automation.scheduleRule as KnorviaAutomationScheduleRule)
    : undefined;
