...
import type { ApplicationIconRequest } from "@knorvia/shared";
import { useKnorviaIntl } from "@/i18n/IntlProvider.js";
import { isKnorviaCuaToolName } from "@/lib/cuaPermissionAction.js";
...
function readCuaToolName(value: string | null | undefined): string | null {
  ...
  //   main namesp: mcp__plugin_knorvia_cua_computer_use__<action>
...
export function isCuaToolCall(
  ...
  return collectToolNames(toolCall).some(isKnorviaCuaToolName);
}
...
type CuaIntl = ReturnType<typeof useKnorviaIntl>["intl"];
