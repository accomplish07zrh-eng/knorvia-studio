 ...
 *
 * 两条纪律与模型面
 * （apps/cli/packages/core/src/tool/handlers/get-workflow-run-format-roster.ts）一字不差：
...
import type { ToolCallGetWorkflowRunDisplay } from "@knorvia/shared/protocol-v4";
...
type FormatMessage = ReturnType<typeof useKnorviaIntl>["intl"]["formatMessage"];
