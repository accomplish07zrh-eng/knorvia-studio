const TASK_NOTIFICATION_ENABLED_STORAGE_KEY = "knorvia-notification-enabled";
const TASK_NOTIFICATION_SOUND_ENABLED_STORAGE_KEY = "knorvia-notification-sound-enabled";
