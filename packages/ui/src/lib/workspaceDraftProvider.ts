...
interface ResolveWorkspaceSwitchDraftProviderOptions {
  currentSelectedProvider: KnorviaProvider;
  targetWorkspacePath: string;
  targetWorkspaceIdentity?: string;
  workspaces: Record<string, WorkspaceKnorviaUIState | undefined>;
}
...
export function resolveWorkspaceSwitchDraftProvider({
  ...
  workspaces,
}: ResolveWorkspaceSwitchDraftProviderOptions): KnorviaProvider {
