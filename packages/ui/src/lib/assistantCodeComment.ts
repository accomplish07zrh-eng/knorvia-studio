...
import { FILE_CITATION_DIRECTIVE_NAMES } from "@/lib/fileCitation.js";
  ...
  if (options.streaming) {
    ...
    if (unclosedStart !== null) {
      ...
      const prefixStart = findAssistantDirectivePrefixStart(
        content,
        [CODE_COMMENT_DIRECTIVE_NAME, ...FILE_CITATION_DIRECTIVE_NAMES],
        protectedRanges,
        {
          minimumSingleColonPrefixLength: ":knorvia".length,
