/**
 * knorvia-plan / Coding Plan 业务错误码与前端处理约定。
 *
 * | 场景           | code | HTTP | 前端处理 |
 * |----------------|------|------|----------|
 ...
 */
import { isOffPeakTicketExpiredError } from "@knorvia/shared";
...
const PROVIDER_BUSINESS_ERROR_MESSAGE_IDS: Record<ProviderBusinessErrorCode, string> = {
  "1006": "knorvia.error.providerBusiness.1006",
  "1005": "knorvia.error.providerBusiness.1005",
  "3006": "knorvia.error.providerBusiness.3006",
  "3002": "knorvia.error.providerBusiness.3002",
  "3001": "knorvia.error.providerBusiness.3001",
  "3007": "knorvia.error.providerBusiness.3007",
  "3008": "knorvia.error.providerBusiness.3008",
  "3009": "knorvia.error.providerBusiness.3009",
  "3010": "knorvia.error.providerBusiness.3010",
  "3102": "knorvia.error.providerBusiness.3102",
  "2007": "knorvia.error.providerBusiness.2007",
  "429": "knorvia.error.providerBusiness.429",
};
