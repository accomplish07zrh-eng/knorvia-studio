...
import type { KnorviaTaskMeta, KnorviaWorkspaceTaskListChanged } from "@knorvia/shared";
...
import { getTaskUnreadIndicator, useKnorviaSessionStore } from "@/store/sessionStore.js";
import { bumpTaskListMembershipVersion } from "@/v4/taskListMembershipVersion.js";
import { logger } from "@/logger.js";

type TaskUnreadService = Pick<IKnorviaTaskService, "setTaskUnread">;
...
function buildStatusUnreadKey(event: KnorviaWorkspaceTaskListChanged, taskId: string): string {
...
function shouldMarkStatusEventTaskUnread(params: {
  ...
  event: KnorviaWorkspaceTaskListChanged;
}): boolean {
