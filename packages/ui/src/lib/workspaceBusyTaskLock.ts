import type { KnorviaProvider, KnorviaTaskRuntimeStatus } from "@knorvia/shared";

function isBusyTaskRuntimeStatus(status: KnorviaTaskRuntimeStatus): boolean {
...
): Record<string, KnorviaProvider | undefined> {
  const providerByTaskId: Record<string, KnorviaProvider | undefined> = {};
