...
export const WORKSPACE_FILE_DRAG_MIME = "application/x-knorvia-workspace-file";
export const WORKSPACE_FILE_ADD_TO_CHAT_EVENT = "knorvia:add-workspace-file-to-chat";
export const WORKSPACE_FILE_DRAG_STATE_EVENT = "knorvia:workspace-file-drag-state";
