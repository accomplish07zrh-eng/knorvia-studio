...
import type { KnorviaModelTrajectory } from "@knorvia/services";
import { logger } from "@/logger.js";
import { useTaskService } from "@/hooks/useTaskService.js";

interface ModelTrajectoryState {
  loading: boolean;
  data: KnorviaModelTrajectory | null;
  error: string | null;
}
 ...
 *
 * 路径解析与文件读取都收口在 taskService.getModelTrajectory（host 侧），
...
export function useModelTrajectory(
  ...
  }, [taskService, taskId, workspaceIdentity, workspacePath, reloadToken]);
