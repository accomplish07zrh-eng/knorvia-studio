...
import type { BackgroundBashOutput, BackgroundBashOutputResult } from "@knorvia/shared";
import { useAgentService } from "@/hooks/useAgentService.js";
...
export function useBackgroundBashOutput(target: BackgroundBashOutputTarget, visible: boolean) {
  ...
  const service = useAgentService(workspacePath, remoteSessionId, workspaceIdentity);
