 ...
 * 组件应通过 hooks 访问服务，不再直接使用 services.* 或 window.knorvia.*。
 */
...
// 系统服务
export { useIntranetProbe, useSystemInfo } from "./useSystemService.js";
...
export { useRecentProjects, useSettings } from "./useSettingService.js";
...
// 凭据服务
export { useAgentService } from "./useAgentService.js";
