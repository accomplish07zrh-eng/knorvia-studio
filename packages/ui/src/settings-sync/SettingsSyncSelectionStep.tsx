...
import type { SettingsSyncCategory, SettingsSyncDiscoveryResult } from "@knorvia/shared";
...
function formatAgentName(agent: string, intl: ReturnType<typeof useKnorviaIntl>["intl"]): string {
  switch (agent) {
    case "knorvia":
      return intl.formatMessage({ id: "settingsSync.agent.knorvia" });
    case "claudeCode":
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex min-w-0 flex-1 items-center gap-2">
                      {renderProviderCliIcon("knorvia", "size-4 shrink-0 text-foreground")}
                      <div className="min-w-0 flex-1">
                        <div className="text-ui-base font-medium leading-none text-foreground">
