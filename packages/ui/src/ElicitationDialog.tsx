...
import type { KnorviaElicitationQuestion, KnorviaElicitationRequest } from "@knorvia/shared";
import type { InteractionAutoResolution } from "@knorvia/shared/protocol-v4";
...
interface ElicitationDialogProps {
  request: KnorviaElicitationRequest;
...
interface NormalizedElicitationQuestion extends KnorviaElicitationQuestion {
  key: string;
}
...
function isPlanApprovalElicitationRequest(request: KnorviaElicitationRequest): boolean {
