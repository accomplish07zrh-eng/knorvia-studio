...
type IntlShape = ReturnType<typeof useKnorviaIntl>["intl"];
...
function compactTextPreview(message: KnorviaModelTrajectoryMessage): string {
...
function firstLinePreview(message: KnorviaModelTrajectoryMessage): string {
...
function messageClipboardText(message: KnorviaModelTrajectoryMessage): string {
