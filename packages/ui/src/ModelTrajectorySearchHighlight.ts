...
const HIGHLIGHT_NAME = "knorvia-model-trajectory-find";
const ACTIVE_HIGHLIGHT_NAME = "knorvia-model-trajectory-find-active";
const STYLE_ID = "knorvia-model-trajectory-find-highlight-style";
