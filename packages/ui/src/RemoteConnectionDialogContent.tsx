...
import { TID_REMOTE_KIND_DOCKER, TID_REMOTE_KIND_SSH, TID_REMOTE_KIND_WSL } from "@knorvia/shared";
import type {
  IMcpSyncService,
  IPluginSyncService,
  IServiceAccessor,
...
export function RemoteConnectionDirectoryStep({
  ...
  localKnorviaAgentService?: IKnorviaAgentService;
  remoteKnorviaAgentService?: IKnorviaAgentService | null;
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col gap-6 h-full" aria-busy={selecting}>
      ...
      <RemoteSyncDialogs
        ...
        localKnorviaAgentService={localKnorviaAgentService}
        remoteKnorviaAgentService={remoteKnorviaAgentService}
