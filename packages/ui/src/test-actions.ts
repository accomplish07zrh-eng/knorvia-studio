...
export interface TestActions extends TaskListE2EActions {
  ...
  getTheme: () => string;
  /** 设置主题 */
  setTheme: (theme: "light" | "dark" | "knorvia-light" | "knorvia-dark" | "system") => void;
  /** 获取当前语言，仅供跨语言展示 E2E */
  ...
  /** E2E 通过真实 agentService 拉取插件 overview */
  getPluginsOverview: IKnorviaAgentService["getPluginsOverview"];
  /** E2E 通过真实 agentService 添加 marketplace */
  addPluginMarketplace: IKnorviaAgentService["addPluginMarketplace"];
  /** E2E 通过真实 agentService 刷新 marketplace */
  updatePluginMarketplace: IKnorviaAgentService["updatePluginMarketplace"];
  /** E2E 通过真实 agentService 安装 marketplace plugin */
  installPlugin: IKnorviaAgentService["installPlugin"];
  /** E2E 通过真实 agentService 触发插件 discover */
  listPlugins: IKnorviaAgentService["listPlugins"];
  /** E2E 通过真实 agentService 查询 Workspace/Session Plugin catalog */
  getPluginReferenceCatalog: IKnorviaAgentService["getPluginReferenceCatalog"];
}
