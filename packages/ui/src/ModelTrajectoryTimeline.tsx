...
import type { KnorviaModelTrajectoryRecord } from "@knorvia/services";
import {
...
export function resolveTrajectoryTimelineItems(records: KnorviaModelTrajectoryRecord[]) {
...
export function resolveTrajectoryInputMessages({
  ...
  inputMessages: KnorviaModelTrajectoryRecord["request"]["messages"];
...
function shouldUseConversationDelta(record: KnorviaModelTrajectoryRecord): boolean {
  const kind = record.callSource?.kind;
  return kind === undefined || kind === "main" || kind === "subagent";
}

function computeDeltaMessages(
  messages: KnorviaModelTrajectoryRecord["request"]["messages"],
  previousMessageCount: number,
  index: number,
): KnorviaModelTrajectoryRecord["request"]["messages"] {
