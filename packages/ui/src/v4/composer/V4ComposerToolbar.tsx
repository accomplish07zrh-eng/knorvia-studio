...
import { useToolbarConfigOptions } from "@/hooks/useConfig.js";
...
import { isApiKeyAccess } from "@knorvia/provider";
...
function V4ComposerModelControlsImpl({
  ...
  const thoughtOption = useMemo<KnorviaConfigOption | null>(() => {
