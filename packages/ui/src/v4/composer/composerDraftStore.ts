...
//
// 旧草稿面（sessionStore composerDraftByScopeId + chatComposerDraftStorage 写路径）
...
import { modelSelectionSchema, type ModelSelection } from "@knorvia/shared";
import { submissionModeSchema, type SubmissionMode } from "@knorvia/shared/protocol-v4";
...
const STORAGE_KEY_PREFIX = "knorvia-v4-composer-drafts:v1:";
