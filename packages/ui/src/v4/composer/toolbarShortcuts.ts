...
import type { ShortcutCommandId, KnorviaConfigOption } from "@knorvia/shared";
import {
...
function getChatToolbarShortcutKey(
  category: KnorviaConfigOption["category"],
...
interface ToolbarShortcutState {
  ...
  modelOption?: KnorviaConfigOption;
  modeOption?: KnorviaConfigOption;
  thoughtOption?: KnorviaConfigOption;
}
