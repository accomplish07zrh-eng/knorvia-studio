...
import { NativeChatMetrics } from "@/chat-input-toolbar/NativeChatMetrics.js";
...
function ConversationComposerImpl({
  ...
  const draftFocusVersion = useKnorviaSessionStore(
  ...
  return (
    ...
    >
      ...
      <ConversationComposerSurface contextHeader={contextHeader}>
      ...
      {!draftMode && snapshot && snapshot.rows.totalCount > 0 ? (
        <NativeChatMetrics
          snapshot={snapshot}
          workspacePath={workspacePath}
          workspaceIdentity={workspaceIdentity}
