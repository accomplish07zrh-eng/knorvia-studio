...
import type { V4ConversationFileRewindPreviewResult } from "@knorvia/shared/protocol-v4";
...
function formatReason(reason: string, intl: ReturnType<typeof useKnorviaIntl>["intl"]) {
