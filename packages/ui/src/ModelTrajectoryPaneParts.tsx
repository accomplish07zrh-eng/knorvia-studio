...
export type IntlShape = ReturnType<typeof useKnorviaIntl>["intl"];
...
export function CallCard({
  ...
  record: KnorviaModelTrajectoryRecord;
  index: number;
  inputMessages: KnorviaModelTrajectoryMessage[];
...
function SourceTitle({ record, intl }: { record: KnorviaModelTrajectoryRecord; intl: IntlShape }) {
  const callSource: NonNullable<KnorviaModelTrajectoryRecord["callSource"]> = record.callSource ?? {
    kind: "main",
  };
...
function MessageBlock({
  ...
  message: KnorviaModelTrajectoryMessage;
...
function ResponseBlock({
  ...
  response: NonNullable<KnorviaModelTrajectoryRecord["response"]>;
  callStartedAt: string;
  callDurationMs?: number;
