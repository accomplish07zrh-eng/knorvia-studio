...
import type { CommandConfig, UserCommand, KnorviaCommand } from "@knorvia/shared";
...
export function CommandsSection({
  ...
  const handleToggle = useCallback(
    async (command: KnorviaCommand, enabled: boolean) => {
  ...
  const renderCommandList = (items: KnorviaCommand[]) => (
    <SettingsResourceList
      items={items}
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <CommandForm
            ...
            agentSource={editingCommand?.agentSource ?? KNORVIA_COMMAND_AGENT_SOURCE}
            scopeKey={formScopeKey}
