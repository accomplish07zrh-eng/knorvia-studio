...
import type { McpSource, KnorviaMcpServer } from "@knorvia/shared";
...
export function McpServerForm({
  ...
  onSave: (form: FormState, prevServer?: KnorviaMcpServer) => void;
  onCancel: () => void;
  onDelete?: (server: KnorviaMcpServer) => void;
}) {
  const { intl } = useKnorviaIntl();
