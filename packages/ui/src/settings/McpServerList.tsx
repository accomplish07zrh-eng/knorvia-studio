...
function McpServerItem({
  ...
  server: KnorviaMcpServer;
  onEdit: (server: KnorviaMcpServer) => void;
  onToggle: (id: string, enabled: boolean) => void;
  onOpenAuthorization?: (server: KnorviaMcpServer) => void;
  ...
  const canEdit = !server.location || server.location.source === "knorvia";
