...
import type {
  ...
  KnorviaImportedSessionSkippedItem,
} from "@knorvia/shared";
...
function ImportIssuesList({
  ...
  title: string;
  items: KnorviaImportedSessionSkippedItem[];
}) {
...
export function MigrationCandidatesCard({
  ...
  candidates: KnorviaImportableSessionCandidate[];
  selectedSessionIds: string[];
  selectedCount: number;
  importError: string | null;
  lastImportResult: KnorviaImportSessionsResult | null;
  isImporting: boolean;
