...
import type { KnorviaOffPeakTask } from "@knorvia/shared";
import {
...
function resolveOffPeakStatusFilterKind(
  task: Pick<KnorviaOffPeakTask, "status">,
...
export function filterOffPeakTasksByStatus<T extends Pick<KnorviaOffPeakTask, "status">>(
  tasks: readonly T[],
