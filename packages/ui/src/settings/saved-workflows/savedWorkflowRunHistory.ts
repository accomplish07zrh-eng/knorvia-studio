...
import type { KnorviaSavedWorkflowRun, KnorviaSavedWorkflowRunStatus } from "@knorvia/shared";
...
): Map<string, KnorviaSavedWorkflowRun> {
  const byName = new Map<string, KnorviaSavedWorkflowRun>();
...
export function savedWorkflowRunDurationMs(run: KnorviaSavedWorkflowRun, now: number): number {
