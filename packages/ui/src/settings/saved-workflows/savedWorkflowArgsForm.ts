...
import type { KnorviaSavedWorkflowArgType, KnorviaSavedWorkflowArgsDeclaration } from "@knorvia/shared";

export interface SavedWorkflowArgField {
  name: string;
  type: KnorviaSavedWorkflowArgType;
  description?: string;
  required: boolean;
  hasDefault: boolean;
...
function formatSavedWorkflowArgValue(type: KnorviaSavedWorkflowArgType, value: unknown): string {
...
export function buildSavedWorkflowArgFields(
  declaration: KnorviaSavedWorkflowArgsDeclaration | undefined,
...
type SavedWorkflowArgRowsCollect =
  | { ok: true; args: KnorviaSavedWorkflowArgsDeclaration | undefined }
...
export function rowsToArgsDeclaration(
  ...
  const args: KnorviaSavedWorkflowArgsDeclaration = {};
