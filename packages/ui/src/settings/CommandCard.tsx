...
import type { UserCommand, KnorviaCommand } from "@knorvia/shared";
import { isPluginCommand, isUserCommand } from "@knorvia/shared";
...
export function isEditableUserCommand(command: KnorviaCommand): command is UserCommand {
  return isUserCommand(command) && command.location.source === "knorvia";
}

interface CommandCardProps {
  command: KnorviaCommand;
  onEdit?: (command: KnorviaCommand) => void;
  onToggle?: (command: KnorviaCommand, enabled: boolean) => void;
  isOperating?: boolean;
