import type { KnorviaPluginComponentKind } from "@knorvia/shared";
...
export interface PluginComponentDisplayGroup {
  kind: KnorviaPluginComponentKind;
...
const COMPONENT_BADGE_STYLES: Record<KnorviaPluginComponentKind, string> = {
...
const COMPONENT_LABEL_IDS: Record<KnorviaPluginComponentKind, string> = {
