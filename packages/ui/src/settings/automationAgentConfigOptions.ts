...
export function buildAutomationModeOption(currentValue: string): KnorviaConfigOption {
  return {
    id: "mode",
    name: "Mode",
    category: "mode",
...
export function resolveAutomationModelItem(
  ...
  // workspace runtime 也可能返回 knorvia-openai-compatible/model 这类包装值，provider 对不上时
...
export function buildAutomationThoughtLevelOption(
  runtimeOption: KnorviaConfigOption | undefined,
  currentValue: string,
