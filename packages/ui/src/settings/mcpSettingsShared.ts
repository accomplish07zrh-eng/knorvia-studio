import type { McpServerConfig, KnorviaMcpServer } from "@knorvia/shared";

export const MCP_SECTIONS = ["knorviaagentmcp"] as const;
...
export function serverToForm(server: KnorviaMcpServer): FormState {
...
// 与 shared 层 convertToKnorviaAgentMcpServer 的 isMcpProtocolVersion 守卫保持同一语义：
