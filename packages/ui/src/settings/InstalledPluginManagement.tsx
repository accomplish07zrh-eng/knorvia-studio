...
import type { KnorviaPluginDiagnostic, KnorviaPluginInfo } from "@knorvia/shared";
 ...
 */
export function PluginWarningList({ warnings }: { warnings: KnorviaPluginDiagnostic[] }) {
  return (
...
export function PluginHookDetails({
  ...
  hooks: NonNullable<KnorviaPluginInfo["hookDetails"]>;
}) {
...
function formatHookCommand(hook: NonNullable<KnorviaPluginInfo["hookDetails"]>[number]): string {
