import { resolveWorkspaceKey, type KnorviaComputerUseOperationEvent } from "@knorvia/shared";
...
interface CuaOperationTurnTracker {
  accept(workspace: CuaOperationWorkspaceTarget, event: KnorviaComputerUseOperationEvent): void;
...
export function createCuaOperationTurnTracker(options: {
  ...
  function accept(
    workspace: CuaOperationWorkspaceTarget,
    event: KnorviaComputerUseOperationEvent,
  ): void {
