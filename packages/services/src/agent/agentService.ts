import { requestPluginReferenceCatalog } from "#src/agent/pluginReferenceCatalogRequest.js";
import {
  localTtftFactsSchema,
  sessionDebugSnapshotSchema,
  type LocalTtftFacts,
} from "@knorvia/shared";
/* oxlint-disable eslint(max-lines) -- Knorvia Protocol transport、通知 wiring 和 app-facing session 方法必须共享同一个 client/emitter 上下文。 */
...
} from "#src/agent/automationToolPolicy.js";
import { KnorviaAgentMcpStatusModeUnsupportedError } from "#src/agent/agentErrors.js";
import { createBackgroundSessionEventCoalescer } from "#src/agent/sessionEventCoalescer.js";
import type { ModelSelectionView } from "@knorvia/provider";
...
import type {
  ...
  KnorviaSavedWorkflowScope,
  KnorviaSessionEvent,
  KnorviaSessionRuntimePreferencesResult,
  KnorviaSessionRuntimePreferencesScope,
...
import {
  ...
  KNORVIA_AGENT_PROVIDER_NOT_READY_CODE,
  KNORVIA_AGENT_PROVIDER_NOT_READY_REASON,
  KNORVIA_MODEL_REASONING_SEPARATOR,
  KNORVIA_PROTOCOL_NAME,
  KNORVIA_PROTOCOL_VERSION,
  KNORVIA_SESSION_RUNTIME_PREFERENCES_REQUEST_TIMEOUT_MS,
  formatLogPrefix,
  isRemoteWorkspaceIdentity,
  resolveWorkspaceKey,
  knorviaAutomationCheckTaskBindingParamsSchema,
  knorviaAutomationCreateParamsSchema,
  knorviaAutomationDeleteParamsSchema,
  knorviaAutomationListParamsSchema,
  knorviaAutomationUpdateParamsSchema,
  knorviaBrowserExecuteParamsSchema,
  knorviaBrowserListParamsSchema,
  knorviaComputerUseOperationEventSchema,
  knorviaMcpListResultSchema,
  knorviaMcpResourceSamplesSchema,
  knorviaMcpTelemetryEventSchema,
  knorviaPermissionRequestParamsSchema,
  knorviaPluginOperationProgressNotificationSchema,
  knorviaPluginsCancelOperationResultSchema,
  knorviaPluginsConfigureResultSchema,
  knorviaPluginsDescribeResultSchema,
  knorviaPluginsInstallResultSchema,
  knorviaPluginsListResultSchema,
  knorviaPluginsMarketplaceMutationResultSchema,
  knorviaPluginsOverviewResultSchema,
  knorviaPluginsResolveSuggestedReferenceResultSchema,
  knorviaPluginsRestoreBuiltinResultSchema,
  knorviaPluginsSetEnabledResultSchema,
  knorviaPluginsUninstallResultSchema,
  knorviaPluginsValidateResultSchema,
  knorviaProcessChildProcessesResultSchema,
  knorviaProcessResourceSampleSchema,
  knorviaProtocolEmptyResultSchema,
  knorviaProtocolMethods,
  knorviaProtocolNotifications,
  knorviaProviderTestModelConnectivityResultSchema,
  sessionCloseResultSchema,
  sessionCompactResultSchema,
  sessionEventSchema,
  sessionEventsResultSchema,
  sessionGoalResultSchema,
  sessionListResultSchema,
  sessionMessagesResultSchema,
  sessionRequestRuntimePreferencesParamsSchema,
  sessionRuntimePreferencesResultSchema,
  sessionSendResultSchema,
  sessionStateSnapshotSchema,
  sessionSubagentsResultSchema,
  sessionSubscribeResultSchema,
  knorviaSkillsReferenceCatalogResultSchema,
  knorviaStateUpdatedNotificationSchema,
  knorviaToolExecResourceSchema,
  knorviaUserInputRequestParamsSchema,
  knorviaWorkflowsDeleteResultSchema,
  knorviaWorkflowsGetResultSchema,
  knorviaWorkflowsListResultSchema,
  knorviaWorkflowsMoveResultSchema,
  knorviaWorkflowsRunsResultSchema,
  knorviaWorkflowsUpdateMetaResultSchema,
  knorviaWorkspaceCancelGenerateTextResultSchema,
  knorviaWorkspaceGenerateTextResultSchema,
  knorviaWorkspaceHookTrustGrantResultSchema,
  knorviaWorkspacePresentationSchema,
  knorviaWorkspaceUpdateDynamicWorkflowPolicyResultSchema,
  knorviaWorkspaceUpdateInteractionPreferencesResultSchema,
  knorviaWorkspaceUpdateModelIoPreferencesResultSchema,
  type AgentLaneResourceSample,
  type DynamicWorkflowClientConfig,
  type ProcessResourceCliLane,
  type TraceId,
  type KnorviaAutomation,
  type KnorviaAutomationRun,
  type KnorviaMcpResourceSample,
  type KnorviaMcpTelemetryEvent,
  type KnorviaPluginOperationProgressNotification,
...
import {
  ...
  KNORVIA_ATTACHMENT_FAULT_CODES,
  KnorviaAttachmentFaultError,
...
import type {
  ...
  KnorviaAgentAppRuntimePreferences,
  KnorviaAgentAppUsageParams,
  KnorviaAgentAttachmentBeginParams,
  KnorviaAgentAttachmentChunkParams,
  KnorviaAgentAttachmentPreviewSourceParams,
  KnorviaAgentAttachmentReadParams,
  KnorviaAgentAttachmentTerminalParams,
  KnorviaAgentAutomationIdParams,
  KnorviaAgentBackgroundBashOutputParams,
  KnorviaAgentCancelPluginOperationParams,
  KnorviaAgentCommandsQueryParams,
  KnorviaAgentCompactParams,
  KnorviaAgentConfigurePluginParams,
  KnorviaAgentConnectionFlowParams,
  KnorviaAgentConversationAttachmentReadParams,
  KnorviaAgentConversationAttachmentStatParams,
  KnorviaAgentConversationCommandParams,
  KnorviaAgentConversationFileChangesParams,
  KnorviaAgentConversationFileRewindPreviewParams,
  KnorviaAgentConversationPlansParams,
  KnorviaAgentConversationResyncParams,
  KnorviaAgentConversationRowsRangeParams,
  KnorviaAgentConversationSubscribeParams,
  KnorviaAgentConversationUnsubscribeParams,
  KnorviaAgentConversationWorkflowRunArtifactDataParams,
  KnorviaAgentConversationWorkflowRunArtifactReadParams,
  KnorviaAgentConversationWorkflowRunArtifactsParams,
  KnorviaAgentConversationWorkflowRunEventsParams,
  KnorviaAgentConversationWorkflowRunNodeResultParams,
  KnorviaAgentConversationWorkflowRunWorkspaceParams,
  KnorviaAgentConversationWorkflowRunsParams,
  ...
  KnorviaAgentGenerateWorkspaceTextParams,
  KnorviaAgentGetSavedWorkflowParams,
  KnorviaAgentGoalParams,
  KnorviaAgentGrantWorkspaceHookTrustParams,
  ...
  KnorviaAgentListSessionSubagentsParams,
  KnorviaAgentListSessionsParams,
  KnorviaAgentMoveSavedWorkflowParams,
  KnorviaAgentPluginReferenceCatalogParams,
  KnorviaAgentPluginViewParams,
  KnorviaAgentReadSessionEventsParams,
  KnorviaAgentReadSessionMessagesParams,
  KnorviaAgentReadSessionParams,
  KnorviaAgentReadWorkspacePresentationParams,
  ...
  KnorviaAgentRespondSessionRuntimePreferencesParams,
  ...
  KnorviaAgentSessionRuntimePreferencesRequest,
  KnorviaAgentSessionSubscribeParams,
  KnorviaAgentSessionTarget,
  KnorviaAgentSessionsIndexSubscribeParams,
  ...
  KnorviaAgentTaskTokenUsageParams,
  KnorviaAgentTestModelConnectivityParams,
  ...
  KnorviaAgentWorkspaceConfigSubscribeParams,
...
} from "./agentBrowserAmbientContext.js";
import {
  readTrustedKnorviaAgentV4Connection,
  readTrustedKnorviaAgentV4UnsubscribeRoute,
} from "./agentConnectionScope.js";
import type { KnorviaAgentProcessManagerOptions } from "./agentProcessManager.js";
import { KnorviaAgentProcessManager } from "./agentProcessManager.js";
import {
  KnorviaProtocolRequestTimeoutError,
  type KnorviaProtocolClient,
} from "./protocolClient.js";

const logger = createServiceLogger("agent-service");
...
interface PendingPermissionRequest {
  client: KnorviaProtocolClient;
  protocolRequestId: KnorviaProtocolRequestId;
}

interface PendingSessionRuntimePreferencesRequest extends PendingPermissionRequest {
  request: KnorviaAgentSessionRuntimePreferencesRequest;
...
function isClosedStdioTransportError(error: unknown): boolean {
  return (
    error instanceof Error && error.message === "Knorvia Studio agent stdio transport is closed"
  );
}
...
function buildWorkspaceRef(params: KnorviaAgentWorkspaceTarget): KnorviaWorkspaceRef {
  return {
...
function savedWorkflowTargetHasWorkspace(
  params: KnorviaAgentSavedWorkflowTarget,
): params is KnorviaAgentWorkspaceTarget & { scope?: KnorviaSavedWorkflowScope } {
  return typeof (params as Partial<KnorviaAgentWorkspaceTarget>).workspacePath === "string";
}

// 只在 `scope` 有定义时下推到 RPC params：不给 scope 的项目档保持与今天逐字一致的线上形状。
function savedWorkflowScopeParam(params: KnorviaAgentSavedWorkflowTarget): {
  scope?: KnorviaSavedWorkflowScope;
} {
  return params.scope === undefined ? {} : { scope: params.scope };
}

function ensurePluginManagementWorkspacePath(): string {
  const workspacePath = join(getKnorviaDataRootDir(), PLUGIN_MANAGEMENT_WORKSPACE_DIR_NAME);
...
// NOTE: this counts ONLY the per-session MCP servers passed through the Knorvia Protocol
// session/create params (the app→protocol channel). It is deliberately independent of the
// CLI/bootstrap MCP servers configured in ~/.knorvia-studio/cli/config.json (mcp.servers), which the agent
// runtime connects separately and reports via the `mcp.server.connected`/toolCount events. So a
// createSession log line with mcpServerCount:0 is EXPECTED when cua is a CLI-config MCP server
...
// real kimi-k2.6 turns call mcp__cua__* tools (get_app_state/type/open_application, status
...
function isProtocolRequestTimeout(error: unknown, method: string): boolean {
  if (error instanceof KnorviaProtocolRequestTimeoutError) {
    return error.method === method;
  }
  return (
    error instanceof Error &&
    error.message === `Knorvia Studio Protocol request timed out: ${method}`
  );
}
...
function buildSessionCreateParams(
  params: KnorviaAgentCreateSessionParams & {
...
function buildSessionResumeParams(
  params: KnorviaAgentResumeSessionParams & {
    dynamicWorkflowEnabled?: boolean;
  },
...
function buildSessionSendParams(
  params: KnorviaAgentSendPromptParams,
...
function buildSessionCompactParams(params: KnorviaAgentCompactParams) {
  return {
    sessionId: params.sessionId,
    inputId: params.inputId,
...
function formatModelSelectionForLog(ref: ModelSelection | undefined): string | null {
  ...
  return reasoningLevel ? `${base}${KNORVIA_MODEL_REASONING_SEPARATOR}${reasoningLevel}` : base;
}

function sessionEventKey(params: KnorviaAgentSessionTarget): string {
...
function permissionRequestKey(params: KnorviaAgentSessionTarget & { requestId: string }): string {
  return `${sessionEventKey(params)}\u0000${params.requestId}`;
}

function userInputRequestKey(params: KnorviaAgentSessionTarget & { requestId: string }): string {
  return `${sessionEventKey(params)}\u0000${params.requestId}`;
}

/** Host 只读取模型是否就绪；实际模型配置仍由 Worker 的 Registry 持有。 */
...
interface KnorviaAgentProviderReadinessSnapshot {
...
): KnorviaAgentProviderReadinessSnapshot {
...
interface WaitingWorkspaceStartup {
  ...
  workspace: KnorviaAgentWorkspaceTarget;
}
...
function createRuntimeUnavailableError(params: KnorviaAgentWorkspaceTarget): Error & {
  code: typeof KNORVIA_AGENT_RUNTIME_UNAVAILABLE_CODE;
  workspaceKey: string;
} {
  const error = new Error("Knorvia Studio Agent runtime is not running.") as Error & {
    code: typeof KNORVIA_AGENT_RUNTIME_UNAVAILABLE_CODE;
    workspaceKey: string;
  };
  error.code = KNORVIA_AGENT_RUNTIME_UNAVAILABLE_CODE;
  error.workspaceKey = resolveWorkspaceKey(params);
  return error;
}

interface CreateKnorviaAgentServiceOptions extends Omit<
  KnorviaAgentProcessManagerOptions,
  "idleTimeoutMs"
> {
  /** 仅供 MCP 状态探测进程使用，不能把空闲回收传给 chat。 */
  mcpStatusIdleTimeoutMs?: number;
  /** App-owned Creation MCP, injected only into local native sessions. */
  ...
  resolveSessionRuntimePreferences?: (
    scope: KnorviaSessionRuntimePreferencesScope,
  ) => Promise<KnorviaSessionRuntimePreferencesResult>;
...
function toProtocolAutomation(automation: KnorviaAutomation) {
  return {
...
export function createKnorviaAgentService(
  options?: CreateKnorviaAgentServiceOptions,
): IKnorviaAgentService & { disposeAllAndWait(): Promise<void> } {
  const processManager = new KnorviaAgentProcessManager(options);
  ...
  const pluginProcessManager = new KnorviaAgentProcessManager({
  ...
  const mcpStatusProcessManager = new KnorviaAgentProcessManager({
    commandResolver: options?.commandResolver,
    presentationSurface: options?.presentationSurface,
  ...
  const sessionEmitters = new Map<string, Emitter<KnorviaAgentServiceEvent>>();
  const sessionRuntimePreferencesRequestEmitter =
    new Emitter<KnorviaAgentSessionRuntimePreferencesRequest>();
  const processResourceSampleEmitter = new Emitter<AgentLaneResourceSample>();
  const toolExecResourceEmitter = new Emitter<KnorviaToolExecResource>();
  const mcpResourceSamplesEmitter = new Emitter<KnorviaMcpResourceSample[]>();
  const mcpTelemetryEmitter = new Emitter<KnorviaMcpTelemetryEvent>();
  const pluginOperationProgressEmitters = new Map<
    string,
    Emitter<KnorviaPluginOperationProgressNotification>
  >();
  ...
  const cuaPermissionObservationEmitter = new Emitter<KnorviaAgentCuaPermissionObservation>();
  ...
  const wiredClients = new WeakSet<KnorviaProtocolClient>();
  const clientDisposables = new WeakMap<KnorviaProtocolClient, IDisposable[]>();
  ...
  let latestAppRuntimePreferences: KnorviaAgentAppRuntimePreferences | undefined;
  ...
  function invalidateWorkspaceClient(workspaceKey: string, client: KnorviaProtocolClient): void {
  ...
  function expireSessionRuntimePreferencesRequest(requestId: string): void {
    ...
    logger.warn(undefined, "运行时偏好请求等待 Host 响应超时", {
      event: "knorvia_agent.runtime_preferences.host_response_timeout",
      module: "services.knorvia_agent",
      requestId,
      scope: pending.request.scope,
      sessionId: pending.request.sessionId,
      timeoutMs: KNORVIA_SESSION_RUNTIME_PREFERENCES_REQUEST_TIMEOUT_MS,
  ...
  function enqueueInteractionPreferenceSync(params: {
    client: KnorviaProtocolClient;
    preferences: KnorviaAgentAppRuntimePreferences;
    workspace: KnorviaAgentWorkspaceTarget;
  }): Promise<void> {
    ...
    const current = previous
      ...
      .then(async () => {
        await params.client.request(
          knorviaProtocolMethods.workspaceUpdateInteractionPreferences,
          {
        ...
        try {
          await params.client.request(
            knorviaProtocolMethods.workspaceUpdateModelIoPreferences,
            {
              workspace: buildWorkspaceRef(params.workspace),
              preferences: {
  ...
  async function handleProviderReadinessChanged(event: {
    reason: string;
    snapshot: KnorviaAgentProviderReadinessSnapshot;
  }): Promise<void> {
    if (event.snapshot.readiness.ready) {
      await Promise.allSettled(
        Array.from(waitingWorkspaceStartups.entries()).map(async ([workspaceKey, waiting]) => {
          ...
          logger.info(undefined, "provider/model 就绪后已启动等待中的 Knorvia Studio agent", {
  ...
  function getSessionEmitter(params: KnorviaAgentSessionTarget) {
    const key = sessionEventKey(params);
    const existing = sessionEmitters.get(key);
    if (existing) {
      return existing;
    }
    const created = new Emitter<KnorviaAgentServiceEvent>();
  ...
  function getPluginOperationProgressEmitter(operationId: string) {
    ...
    let created: Emitter<KnorviaPluginOperationProgressNotification>;
    created = new Emitter({
  ...
  function getConversationFrameEmitter(workspace: KnorviaAgentWorkspaceTarget) {
  ...
  function getConversationTelemetryFactEmitter(workspace: KnorviaAgentWorkspaceTarget) {
    const key = resolveWorkspaceKey(workspace);
  ...
  function getSessionsIndexFrameEmitter(workspace: KnorviaAgentWorkspaceTarget) {
    const key = resolveWorkspaceKey(workspace);
  ...
  function getWorkspaceConfigFrameEmitter(workspace: KnorviaAgentWorkspaceTarget) {
    const key = resolveWorkspaceKey(workspace);
  ...
  function resolveV4Connection(params: unknown, fallbackConnectionId: string = v4ConnectionId) {
    return (
      readTrustedKnorviaAgentV4Connection(params) ?? {
  ...
  function resolveV4UnsubscribeRoute(
    params: KnorviaAgentConversationUnsubscribeParams | KnorviaAgentConversationResyncParams,
    topicPrefix: string,
  ): V4SubscriptionRoute | null {
    const expectedWorkspaceKey = resolveWorkspaceKey(params);
    const trusted = readTrustedKnorviaAgentV4UnsubscribeRoute(params);
    if (trusted) {
  ...
  async function unsubscribeV4Route(
    params: KnorviaAgentConversationUnsubscribeParams,
    topicPrefix: string,
  ): Promise<void> {
  ...
  async function resyncV4Route(params: KnorviaAgentConversationResyncParams, topicPrefix: string) {
    const route = resolveV4UnsubscribeRoute(params, topicPrefix);
  ...
  function handleStateUpdated(
    workspace: KnorviaAgentWorkspaceTarget,
    notification: KnorviaStateUpdatedNotification,
  ): void {
  ...
  function wireClient(
    ...
    const disposables = [
      client.onNotification((message) => {
        if (message.method === knorviaProtocolNotifications.processResourceSample) {
          const parsed = knorviaProcessResourceSampleSchema.safeParse(message.params);
          if (parsed.success) {
            processResourceSampleEmitter.fire({ ...parsed.data, lane });
          } else {
            logger.debug(undefined, "丢弃无效 Knorvia Studio CLI 资源样本", {
        ...
        if (message.method === knorviaProtocolNotifications.toolExecResource) {
          const parsed = knorviaToolExecResourceSchema.safeParse(message.params);
          if (parsed.success) toolExecResourceEmitter.fire(parsed.data);
          return;
        }
        if (message.method === knorviaProtocolNotifications.mcpResourceSamples) {
          const parsed = knorviaMcpResourceSamplesSchema.safeParse(message.params);
          if (parsed.success) mcpResourceSamplesEmitter.fire(parsed.data);
          else logger.debug(undefined, "丢弃无效 MCP 资源样本");
          return;
        }

        if (message.method === knorviaProtocolNotifications.mcpTelemetry) {
          const parsed = knorviaMcpTelemetryEventSchema.safeParse(message.params);
          if (parsed.success) {
            mcpTelemetryEmitter.fire(parsed.data);
          } else {
            logger.debug(undefined, "丢弃无效 Knorvia Studio CLI MCP 遥测事件", {
              issues: parsed.error.issues.map((issue) => ({
                code: issue.code,
                path: issue.path.join("."),
              })),
        ...
        if (message.method === knorviaProtocolNotifications.pluginOperationProgress) {
          const parsed = knorviaPluginOperationProgressNotificationSchema.safeParse(message.params);
          if (parsed.success) {
            pluginOperationProgressEmitters.get(parsed.data.operationId)?.fire(parsed.data);
          } else {
            logger.warn(undefined, "丢弃无效 Knorvia Studio Protocol 插件操作进度", {
              issues: parsed.error.issues.map((issue) => ({
                code: issue.code,
        ...
        if (message.method === knorviaProtocolMethods.computerUseOperationEvent) {
          const parsed = knorviaComputerUseOperationEventSchema.safeParse(message.params);
          if (parsed.success) {
            ...
            logger.warn(
              undefined,
              "丢弃无效 Knorvia Studio Protocol Computer Use operation event",
              {
                issues: parsed.error.issues.map((issue) => ({
                  code: issue.code,
                  message: issue.message,
        ...
        if (message.method === "session/event") {
          const parsed = sessionEventSchema.safeParse(message.params);
          if (parsed.success) {
            ...
            logger.warn(
              ...
              "丢弃无效 Knorvia Studio Protocol session event",
              {
        ...
        if (message.method === "state.updated") {
          const parsed = knorviaStateUpdatedNotificationSchema.safeParse(message.params);
          if (parsed.success) {
      ...
      client.onRequest((request) => {
        if (request.method === knorviaProtocolMethods.sessionRequestRuntimePreferences) {
          ...
          const dynamicRequest: KnorviaAgentSessionRuntimePreferencesRequest = {
            ...parsed.data,
            requestId,
          };
          ...
          logger.info(undefined, "运行时偏好请求已转发给 Host", {
            event: "knorvia_agent.runtime_preferences.host_request_dispatched",
            module: "services.knorvia_agent",
            requestId,
        ...
        if (request.method === knorviaProtocolMethods.interactionRequestPermission) {
          const parsed = knorviaPermissionRequestParamsSchema.safeParse(request.params);
          if (!parsed.success) {
        ...
        if (request.method === knorviaProtocolMethods.interactionRequestUserInput) {
          const parsed = knorviaUserInputRequestParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === knorviaProtocolMethods.interactionBrowserList) {
          const parsed = knorviaBrowserListParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === knorviaProtocolMethods.interactionBrowserExecute) {
          const parsed = knorviaBrowserExecuteParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === knorviaProtocolMethods.automationCreate) {
          const parsed = knorviaAutomationCreateParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === knorviaProtocolMethods.automationList) {
          const parsed = knorviaAutomationListParamsSchema.safeParse(request.params ?? {});
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === knorviaProtocolMethods.automationCheckTaskBinding) {
          const parsed = knorviaAutomationCheckTaskBindingParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === knorviaProtocolMethods.automationUpdate) {
          const parsed = knorviaAutomationUpdateParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === knorviaProtocolMethods.automationDelete) {
          const parsed = knorviaAutomationDeleteParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        void client.respondError(request.id, {
          code: -32601,
          message: `Unsupported Knorvia Studio Protocol request: ${request.method}`,
        });
      }),
      client.onClose(() => {
  ...
  function getSessionTraceId(target: KnorviaAgentSessionTarget): TraceId | undefined {
  ...
  function createProviderNotReadyError(params: {
    ...
    code: typeof KNORVIA_AGENT_PROVIDER_NOT_READY_CODE;
    data: {
      providerCount: number;
      reason: typeof KNORVIA_AGENT_PROVIDER_NOT_READY_REASON;
    ...
    const error = new Error(
      "当前没有可用的模型供应商和模型，请在模型设置中配置 API Key 和模型。",
    ) as Error & {
      code: typeof KNORVIA_AGENT_PROVIDER_NOT_READY_CODE;
      data: {
        providerCount: number;
    ...
    error.code = KNORVIA_AGENT_PROVIDER_NOT_READY_CODE;
    error.data = {
      providerCount: params.snapshot?.providerCount ?? 0,
      reason: KNORVIA_AGENT_PROVIDER_NOT_READY_REASON,
  ...
  function isProviderNotReadyError(
    error: unknown,
  ): error is Error & { code: typeof KNORVIA_AGENT_PROVIDER_NOT_READY_CODE } {
    return (
      error instanceof Error &&
      (error as { code?: unknown }).code === KNORVIA_AGENT_PROVIDER_NOT_READY_CODE
    );
  }

  async function resolveStartupReadiness(): Promise<
    KnorviaAgentProviderReadinessSnapshot | undefined
  > {
  ...
  function isReusableActiveClientEntry(
    ...
    activeClientsByWorkspaceKey.delete(workspaceKey);
    interactionPreferenceSyncByWorkspaceKey.delete(workspaceKey);
    logger.warn(undefined, "复用的 Knorvia Studio Protocol client 已 disposed，清理 stale entry", {
      workspaceKey,
      workspacePath: params.workspacePath,
    });
    return false;
  ...
  async function getOrStartReadOnlyClient(
    ...
    const interactionPreferencesReady = (async () => {
      let appliedSnapshot: KnorviaAgentAppRuntimePreferences | undefined;
    ...
    const dynamicWorkflowPolicyReady = (async () => {
      ...
      try {
        await client.request(
          knorviaProtocolMethods.workspaceUpdateDynamicWorkflowPolicy,
    ...
    logger.info(undefined, "为只读会话控制面启动 Knorvia Studio agent", {
      workspaceKey,
      workspacePath: params.workspacePath,
    });
    return entry;
  ...
  async function getClient(params: KnorviaAgentWorkspaceTarget) {
    const workspaceKey = resolveWorkspaceKey(params);
    const active = activeClientsByWorkspaceKey.get(workspaceKey);
    ...
    if (!readinessSnapshot || !readiness?.ready) {
      ...
      if (waiting.lastLoggedRevision !== revision) {
        ...
        logger.info(
          undefined,
          active
            ? "provider/model 尚未就绪，Knorvia Studio agent 保持只读"
            : "provider/model 尚未就绪，Knorvia Studio agent 保持未启动",
          {
    ...
    waitingWorkspaceStartups.delete(workspaceKey);
    logger.info(undefined, "provider/model 就绪，允许 Knorvia Studio agent 模型执行", {
  ...
  async function getPluginManagementClient(): Promise<KnorviaProtocolClient> {
  ...
  // homedir() 即用户家目录，全局根 `~/.knorvia-studio/workflows/` 因此解析到真实目录。
  // 远程 runtime（SSH/WSL identity 或带 remoteSessionId）的 home 不是本机，绝不选它当载体。
  function isLocalActiveWorkspaceClient(workspace: KnorviaAgentWorkspaceTarget): boolean {
    return (
      !workspace.remoteSessionId &&
      !(workspace.workspaceIdentity && isRemoteWorkspaceIdentity(workspace.workspaceIdentity))
    );
  ...
  async function resolveSavedWorkflowCarrier(
    params: KnorviaAgentSavedWorkflowTarget,
  ): Promise<{ client: KnorviaProtocolClient; workspace: KnorviaWorkspaceRef }> {
  ...
  async function getMcpStatusClient(): Promise<KnorviaProtocolClient> {
    const workspace = { workspacePath: ensurePluginManagementWorkspacePath() };
  ...
  async function buildConversationCommandEnvelope(
    params: KnorviaAgentConversationCommandParams,
    ...
    if (envelope.type === "createSession") {
      ...
      const creationServer =
        !params.workspaceIdentity && !params.remoteSessionId
          ? await options?.creationMcpServer?.(params.workspacePath)
          : undefined;
      if (!dynamicWorkflowEnabled && !creationServer) return envelope;
      ...
      return {
        ...
        payload: {
          ...
          ...(creationServer
            ? {
                mcpServers: [
                  ...(payload.mcpServers ?? []).filter(
                    (server) => server.name !== creationServer.name,
                  ),
                  creationServer,
                ],
              }
  ...
  return {
    ...
    async initialize(params: KnorviaAgentWorkspaceTarget): Promise<KnorviaAgentInitializeResult> {
      const workspaceKey = resolveWorkspaceKey(params);
      const startedAt = Date.now();
      logger.info(undefined, "开始初始化 Knorvia Studio agent", {
        workspaceKey,
        workspacePath: params.workspacePath,
      });
      try {
        const client = await getClient(params);
        logger.info(undefined, "Knorvia Studio agent 初始化完成", {
        ...
        return {
          available: true,
          workspaceKey,
          protocolName: KNORVIA_PROTOCOL_NAME,
          protocolVersion: KNORVIA_PROTOCOL_VERSION,
          transportKind: client.transportKind === "websocket" ? "websocket" : "stdio",
        };
      } catch (error) {
        ...
        logger[providerNotReady ? "info" : "warn"](
          undefined,
          providerNotReady
            ? "Knorvia Studio agent 等待 provider/model 就绪"
            : "Knorvia Studio agent 初始化失败",
          {
            durationMs: Date.now() - startedAt,
            message: error instanceof Error ? error.message : String(error),
            workspaceKey,
        ...
        return {
          ...
          ...(providerNotReady ? { reasonCode: KNORVIA_AGENT_PROVIDER_NOT_READY_REASON } : {}),
        };
      }
    },

    async syncAppRuntimePreferences(preferences: KnorviaAgentAppRuntimePreferences): Promise<void> {
      const normalizedPreferences: KnorviaAgentAppRuntimePreferences = {
        ...preferences,
    ...
    async getWorkspaceRuntimeIdentity(params: KnorviaAgentWorkspaceTarget) {
    ...
    async createSession(params: KnorviaAgentCreateSessionParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      const sessionTraceId = params.sessionTraceId;
      logger.info(sessionTraceId, "开始请求 Knorvia Studio Protocol session/create", {
      ...
      try {
        const snapshot = await client.request(
          knorviaProtocolMethods.sessionCreate,
        ...
        logger.info(sessionTraceId, "Knorvia Studio Protocol session/create 完成", {
          durationMs: Date.now() - startedAt,
        ...
        if (compatFields.length === 0) {
          logger.warn(sessionTraceId, "Knorvia Studio Protocol session/create 失败", {
            durationMs: Date.now() - startedAt,
            message: error instanceof Error ? error.message : String(error),
            persistence: params.persistence,
            workspaceKey: resolveWorkspaceKey(params),
        ...
        logger.warn(sessionTraceId, "Knorvia Studio Protocol session/create 命中新旧协议兼容重试", {
          compatFields,
          durationMs: Date.now() - startedAt,
          workspaceKey: resolveWorkspaceKey(params),
          workspacePath: params.workspacePath,
        ...
        if (!compatFields.includes("thoughtLevel") || !params.thoughtLevel) {
          logger.info(sessionTraceId, "Knorvia Studio Protocol session/create 兼容重试完成", {
            durationMs: Date.now() - startedAt,
            sessionId: snapshot.session.sessionId,
            snapshotTraceId: snapshot.session.traceId ?? null,
            workspaceKey: resolveWorkspaceKey(params),
        ...
        const snapshotWithThoughtLevel = await client.request(
          knorviaProtocolMethods.sessionSetThoughtLevel,
          {
            sessionId: snapshot.session.sessionId,
            thoughtLevel: params.thoughtLevel,
        ...
        logger.info(
          sessionTraceId,
          "Knorvia Studio Protocol session/create 兼容重试后设置 thoughtLevel 完成",
          {
            durationMs: Date.now() - startedAt,
            sessionId: snapshot.session.sessionId,
    ...
    async resumeSession(params: KnorviaAgentResumeSessionParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      const cachedTraceId = getSessionTraceId(params);
      // 冷恢复同样按 Host 的灰度判定下发，否则恢复出来的会话会丢掉工作流工具簇。
      const dynamicWorkflowEnabled = await resolveDynamicWorkflowGate();
      logger.info(cachedTraceId, "开始请求 Knorvia Studio Protocol session/resume", {
        mcpServerCount: getMcpServerCount(params),
        mcpServerNames: getMcpServerNames(params),
      ...
      try {
        const snapshot = await client.request(
          knorviaProtocolMethods.sessionResume,
        ...
        logger.info(sessionTraceId, "Knorvia Studio Protocol session/resume 完成", {
          durationMs: Date.now() - startedAt,
          messageCount: snapshot.messages.length,
          modelCurrent: formatModelSelectionForLog(snapshot.settings.model.current),
          mcpServerCount: getMcpServerCount(params),
        ...
        if (compatFields.length === 0) {
          logger.warn(cachedTraceId, "Knorvia Studio Protocol session/resume 失败", {
            durationMs: Date.now() - startedAt,
            message: error instanceof Error ? error.message : String(error),
            sessionId: params.sessionId,
            workspaceKey: resolveWorkspaceKey(params),
        ...
        logger.warn(cachedTraceId, "Knorvia Studio Protocol session/resume 命中新旧协议兼容重试", {
          compatFields,
          durationMs: Date.now() - startedAt,
          sessionId: params.sessionId,
          workspaceKey: resolveWorkspaceKey(params),
        ...
        const sessionTraceId = rememberSessionTrace(params, snapshot) ?? cachedTraceId;
        logger.info(sessionTraceId, "Knorvia Studio Protocol session/resume 兼容重试完成", {
          durationMs: Date.now() - startedAt,
          sessionId: params.sessionId,
          snapshotTraceId: snapshot.session.traceId ?? null,
          workspaceKey: resolveWorkspaceKey(params),
    ...
    async listSessions(params: KnorviaAgentListSessionsParams) {
      const client = await getReadOnlyClient(params, params.runtimePolicy);
      const result = await client.request(
        knorviaProtocolMethods.sessionList,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async listSessionSubagents(params: KnorviaAgentListSessionSubagentsParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
        knorviaProtocolMethods.sessionSubagents,
        {
          sessionId: params.sessionId,
    ...
    async getAppUsageStats(params: KnorviaAgentAppUsageParams) {
    ...
    async getTaskTokenUsage(params: KnorviaAgentTaskTokenUsageParams) {
      const client = await getReadOnlyClient(params);
    ...
    async readSession(params: KnorviaAgentReadSessionParams) {
      const client = await getReadOnlyClient(params, params.runtimePolicy);
      ...
      const snapshot = await client.request(
        knorviaProtocolMethods.sessionRead,
        {
          sessionId: params.sessionId,
    ...
    async readSessionMessages(params: KnorviaAgentReadSessionMessagesParams) {
      const client = await getReadOnlyClient(params);
      const result = await client.request(
        knorviaProtocolMethods.sessionMessages,
        {
          sessionId: params.sessionId,
    ...
    async readSessionDebug(params) {
      ...
      return client.request(
        knorviaProtocolMethods.sessionDebug,
        { sessionId: params.sessionId },
        sessionDebugSnapshotSchema,
      );
    },

    async readSessionEvents(params: KnorviaAgentReadSessionEventsParams) {
      const client = await getReadOnlyClient(params);
      const result = await client.request(
        knorviaProtocolMethods.sessionEvents,
        {
          sessionId: params.sessionId,
          afterSeq: params.afterSeq,
          limit: params.limit,
    ...
    async readWorkspacePresentation(params: KnorviaAgentReadWorkspacePresentationParams) {
      const startedAt = Date.now();
      logger.info(undefined, "开始请求 Knorvia Studio Protocol workspace/readPresentation", {
        workspaceKey: resolveWorkspaceKey(params),
        workspacePath: params.workspacePath,
      });
      try {
        let presentation: KnorviaWorkspacePresentation | undefined;
        for (let attempt = 0; attempt < 2; attempt += 1) {
          const client = await getReadOnlyClient(params);
          try {
            presentation = await client.request(
              knorviaProtocolMethods.workspaceReadPresentation,
              { workspace: buildWorkspaceRef(params) },
              knorviaWorkspacePresentationSchema,
            );
            break;
        ...
        if (!presentation) {
          throw new Error(
            "Knorvia Studio Protocol workspace/readPresentation did not return a result",
          );
        }
        logger.info(undefined, "Knorvia Studio Protocol workspace/readPresentation 完成", {
          durationMs: Date.now() - startedAt,
        ...
        logger.warn(undefined, "Knorvia Studio Protocol workspace/readPresentation 失败", {
          durationMs: Date.now() - startedAt,
          message: error instanceof Error ? error.message : String(error),
          workspaceKey: resolveWorkspaceKey(params),
          workspacePath: params.workspacePath,
    ...
    async grantWorkspaceHookTrust(params: KnorviaAgentGrantWorkspaceHookTrustParams) {
    ...
    async listMcpServerStatuses(params: KnorviaAgentListMcpServerStatusesParams) {
      ...
      try {
        ...
        if (params.mode === "status" && unrecognizedKeys.includes("mode")) {
          ...
          throw new KnorviaAgentMcpStatusModeUnsupportedError();
        }
        if (
        ...
        if (!isProtocolRequestTimeout(error, knorviaProtocolMethods.mcpList)) {
          throw error;
        }
    ...
    async listPlugins(params: KnorviaAgentPluginViewParams) {
      const requestPluginsList = async () => {
        ...
        return client.request(
          knorviaProtocolMethods.pluginsList,
          {
            workspace: buildWorkspaceRef(params),
      ...
      try {
        ...
        if (!isProtocolRequestTimeout(error, knorviaProtocolMethods.pluginsList)) {
          throw error;
        }
    ...
    async getPluginReferenceCatalog(params: KnorviaAgentPluginReferenceCatalogParams) {
    ...
    async getSkillReferenceCatalog(params: KnorviaAgentSkillReferenceCatalogParams) {
      // 与 Plugin 引用一样，Session 快照只存在于 workspace agent 进程；独立管理进程
      // 没有 resident Session，不能作为对话 authority。
      const client = await getReadOnlyClient(params);
      return client.request(
        knorviaProtocolMethods.skillsReferenceCatalog,
        {
          workspace: buildWorkspaceRef(params),
          ...(params.sessionId ? { sessionId: params.sessionId } : {}),
        },
    ...
    // `scope` 只在有定义时下推。
    async listSavedWorkflows(params: KnorviaAgentListSavedWorkflowsParams) {
      const { client, workspace } = await resolveSavedWorkflowCarrier(params);
      return client.request(
        knorviaProtocolMethods.workflowsList,
        { workspace, ...savedWorkflowScopeParam(params) },
        knorviaWorkflowsListResultSchema,
      );
    },

    async getSavedWorkflow(params: KnorviaAgentGetSavedWorkflowParams) {
      const { client, workspace } = await resolveSavedWorkflowCarrier(params);
      return client.request(
        knorviaProtocolMethods.workflowsGet,
        { workspace, name: params.name, ...savedWorkflowScopeParam(params) },
        knorviaWorkflowsGetResultSchema,
      );
    },

    async updateSavedWorkflowMeta(params: KnorviaAgentUpdateSavedWorkflowMetaParams) {
      const { client, workspace } = await resolveSavedWorkflowCarrier(params);
      return client.request(
        knorviaProtocolMethods.workflowsUpdateMeta,
        { workspace, name: params.name, meta: params.meta, ...savedWorkflowScopeParam(params) },
        knorviaWorkflowsUpdateMetaResultSchema,
      );
    },

    async deleteSavedWorkflow(params: KnorviaAgentDeleteSavedWorkflowParams) {
      const { client, workspace } = await resolveSavedWorkflowCarrier(params);
      return client.request(
        knorviaProtocolMethods.workflowsDelete,
        { workspace, name: params.name, ...savedWorkflowScopeParam(params) },
        knorviaWorkflowsDeleteResultSchema,
      );
    },

    async listSavedWorkflowRuns(params: KnorviaAgentListSavedWorkflowRunsParams) {
      const { client, workspace } = await resolveSavedWorkflowCarrier(params);
      return client.request(
        knorviaProtocolMethods.workflowsRuns,
        {
          workspace,
    ...
    async moveSavedWorkflow(params: KnorviaAgentMoveSavedWorkflowParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
        knorviaProtocolMethods.workflowsMove,
    ...
    async collectLocalRuntimeChildProcesses(signal?: AbortSignal) {
      ...
      return Promise.all(
        managed.map(async (runtime) => {
          let children: KnorviaProcessChildProcess[] = [];
          try {
            const result = await runtime.client.request(
              knorviaProtocolMethods.processChildProcesses,
              {},
              knorviaProcessChildProcessesResultSchema,
    ...
    async getPluginsOverview(params: KnorviaAgentPluginViewParams) {
      const client = await getPluginManagementClient();
      return client.request(
        knorviaProtocolMethods.pluginsOverview,
        {
          workspace: buildWorkspaceRef(params),
          ...(params.configScope ? { configScope: params.configScope } : {}),
        },
    ...
    async addPluginMarketplace(params: KnorviaAgentAddPluginMarketplaceParams) {
      const client = await getPluginManagementClient();
      return client.request(
        knorviaProtocolMethods.pluginsMarketplaceAdd,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async removePluginMarketplace(params: KnorviaAgentRemovePluginMarketplaceParams) {
      const client = await getPluginManagementClient();
      return client.request(
        knorviaProtocolMethods.pluginsMarketplaceRemove,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async updatePluginMarketplace(params: KnorviaAgentUpdatePluginMarketplaceParams) {
      const client = await getPluginManagementClient();
      return client.request(
        knorviaProtocolMethods.pluginsMarketplaceUpdate,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async installPlugin(params: KnorviaAgentInstallPluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        knorviaProtocolMethods.pluginsInstall,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async cancelPluginOperation(params: KnorviaAgentCancelPluginOperationParams) {
      const client = await getPluginManagementClient();
      return client.request(
        knorviaProtocolMethods.pluginsCancelOperation,
        { operationId: params.operationId },
        knorviaPluginsCancelOperationResultSchema,
    ...
    async uninstallPlugin(params: KnorviaAgentUninstallPluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        knorviaProtocolMethods.pluginsUninstall,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async updatePlugin(params: KnorviaAgentUpdatePluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        knorviaProtocolMethods.pluginsUpdate,
        {
          workspace: buildWorkspaceRef(params),
          ...(params.pluginId ? { pluginId: params.pluginId } : {}),
          ...(params.marketplace ? { marketplace: params.marketplace } : {}),
    ...
    async restoreBuiltinPlugin(params: KnorviaAgentRestoreBuiltinPluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        knorviaProtocolMethods.pluginsRestoreBuiltin,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async configurePlugin(params: KnorviaAgentConfigurePluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        knorviaProtocolMethods.pluginsConfigure,
        {
          workspace: buildWorkspaceRef(params),
          pluginId: params.pluginId,
    ...
    async resetPluginConfig(params: KnorviaAgentResetPluginConfigParams) {
      const client = await getPluginManagementClient();
      return client.request(
        knorviaProtocolMethods.pluginsResetConfig,
        {
          workspace: buildWorkspaceRef(params),
          pluginId: params.pluginId,
          ...(params.scope ? { scope: params.scope } : {}),
    ...
    async validatePlugin(params: KnorviaAgentValidatePluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        knorviaProtocolMethods.pluginsValidate,
        {
          workspace: buildWorkspaceRef(params),
          ...(params.pluginName ? { pluginName: params.pluginName } : {}),
          ...(params.marketplace ? { marketplace: params.marketplace } : {}),
    ...
    async describePlugin(params: KnorviaAgentDescribePluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        knorviaProtocolMethods.pluginsDescribe,
        {
          workspace: buildWorkspaceRef(params),
          marketplace: params.marketplace,
          pluginName: params.pluginName,
    ...
    async setPluginEnabled(params: KnorviaAgentSetPluginEnabledParams) {
      const client = await getPluginManagementClient();
      return client.request(
        knorviaProtocolMethods.pluginsSetEnabled,
        {
          workspace: buildWorkspaceRef(params),
          pluginId: params.pluginId,
    ...
    async listAutomations(params: KnorviaAgentWorkspaceTarget) {
    ...
    async createAutomation(params: KnorviaAgentCreateAutomationParams) {
    ...
    async updateAutomation(params: KnorviaAgentUpdateAutomationParams) {
      return automationService.update(
        params.automationId,
        {
          ...
          prompt: params.prompt,
          modelSelection: params.modelSelection,
          mode: params.mode === null ? null : (params.mode as KnorviaTaskMode | undefined),
    ...
    async deleteAutomation(params: KnorviaAgentAutomationIdParams) {
    ...
    async setAutomationEnabled(params: KnorviaAgentSetAutomationEnabledParams) {
    ...
    async restartAutomation(params: KnorviaAgentAutomationIdParams) {
    ...
    async runAutomationNow(params: KnorviaAgentAutomationIdParams) {
    ...
    async listAutomationRuns(params: KnorviaAgentAutomationIdParams) {
    ...
    async deleteAutomationRun(params: KnorviaAgentDeleteAutomationRunParams) {
    ...
    async generateWorkspaceText(params: KnorviaAgentGenerateWorkspaceTextParams) {
      const client = await getClient(params);
      ...
      const cancel = () => {
        ...
        void client
          .request(
            knorviaProtocolMethods.workspaceCancelGenerateText,
            { operationId },
            knorviaWorkspaceCancelGenerateTextResultSchema,
            { timeoutMs: 5_000 },
          )
      ...
      try {
        return await client.request(
          knorviaProtocolMethods.workspaceGenerateText,
          {
            workspace: buildWorkspaceRef(params),
    ...
    async testModelConnectivity(params: KnorviaAgentTestModelConnectivityParams) {
      const client = await getClient(params);
      return client.request(
        knorviaProtocolMethods.providerTestModelConnectivity,
        {
          workspace: buildWorkspaceRef(params),
          selection: params.selection,
        },
    ...
    async sendPrompt(params: KnorviaAgentSendPromptParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      ...
      const protocolParams: KnorviaAgentSendPromptParams = {
        ...params,
        ...(browserAmbientContext ? { browserAmbientContext } : {}),
      };
      logger.info(logTraceId, "Knorvia Studio Agent session/send 开始", {
      ...
      try {
        const result = await client.request(
          knorviaProtocolMethods.sessionSend,
          buildSessionSendParams(protocolParams),
          sessionSendResultSchema,
        );
        logger.info(logTraceId, "Knorvia Studio Agent session/send ACK", {
          durationMs: Date.now() - startedAt,
          inputId: params.inputId,
          queryId: params.queryId ?? null,
          sessionId: params.sessionId,
        ...
        if (compatFields.length > 0) {
          logger.warn(logTraceId, "Knorvia Studio Agent session/send 命中新旧协议兼容重试", {
            compatFields,
            durationMs: Date.now() - startedAt,
            sessionId: params.sessionId,
            workspaceKey: resolveWorkspaceKey(params),
        ...
        logger.warn(logTraceId, "Knorvia Studio Agent session/send 失败", {
          durationMs: Date.now() - startedAt,
          error: error instanceof Error ? error.message : String(error),
          inputId: params.inputId,
          queryId: params.queryId ?? null,
    ...
    async compactSession(params: KnorviaAgentCompactParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      const sessionTraceId = getSessionTraceId(params);
      logger.info(
        sessionTraceId ?? params.inputId,
        "Knorvia Studio Protocol session/compact 开始",
        {
          inputId: params.inputId,
          sessionId: params.sessionId,
          workspaceKey: resolveWorkspaceKey(params),
      ...
      try {
        const result = await client.request(
          knorviaProtocolMethods.sessionCompact,
        ...
        logger.info(
          sessionTraceId ?? params.inputId,
          "Knorvia Studio Protocol session/compact ACK",
          {
            durationMs: Date.now() - startedAt,
            inputId: params.inputId,
            sessionId: params.sessionId,
        ...
        logger.warn(
          sessionTraceId ?? params.inputId,
          "Knorvia Studio Protocol session/compact 失败",
          {
            durationMs: Date.now() - startedAt,
            error: error instanceof Error ? error.message : String(error),
            inputId: params.inputId,
    ...
    async goalSession(params: KnorviaAgentGoalParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      logger.info(params.inputId, "开始请求 Knorvia Studio Protocol session/goal", {
      ...
      try {
        const result = await client.request(
          knorviaProtocolMethods.sessionGoal,
          {
            sessionId: params.sessionId,
            inputId: params.inputId,
            action: params.action,
        ...
        logger.info(params.inputId, "Knorvia Studio Protocol session/goal 完成", {
          action: params.action,
          durationMs: Date.now() - startedAt,
        ...
        logger.warn(params.inputId, "Knorvia Studio Protocol session/goal 失败", {
          action: params.action,
          durationMs: Date.now() - startedAt,
          message: error instanceof Error ? error.message : String(error),
          sessionId: params.sessionId,
    ...
    async closeSession(
      params: KnorviaAgentSessionTarget & {
        expectedPersistence?: "deferred" | "immediate";
      },
    ): Promise<boolean> {
      const client = await getClient(params);
      const result = await client.request(
        knorviaProtocolMethods.sessionClose,
        {
          sessionId: params.sessionId,
    ...
    async setModel(params: KnorviaAgentSetModelParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      logger.info(undefined, "开始请求 Knorvia Studio Protocol session/setModel", {
      ...
      try {
        const snapshot = await client.request(
          knorviaProtocolMethods.sessionSetModel,
          {
            sessionId: params.sessionId,
            model: params.model,
            expectedRevision: params.expectedRevision,
        ...
        logger.info(undefined, "Knorvia Studio Protocol session/setModel 完成", {
          durationMs: Date.now() - startedAt,
          requestedModel: formatModelSelectionForLog(params.model),
          sessionId: params.sessionId,
        ...
        logger.warn(undefined, "Knorvia Studio Protocol session/setModel 失败", {
          durationMs: Date.now() - startedAt,
          message: error instanceof Error ? error.message : String(error),
          requestedModel: formatModelSelectionForLog(params.model),
          sessionId: params.sessionId,
    ...
    async setThoughtLevel(params: KnorviaAgentSetThoughtLevelParams) {
      const client = await getClient(params);
      const snapshot = await client.request(
        knorviaProtocolMethods.sessionSetThoughtLevel,
        {
    ...
    async setMode(params: KnorviaAgentSetModeParams) {
      const client = await getClient(params);
      return client.request(
        knorviaProtocolMethods.sessionSetMode,
        {
          sessionId: params.sessionId,
          mode: params.mode,
          expectedRevision: params.expectedRevision,
    ...
    async respondSessionRuntimePreferences(
      ...
      if (!pending) {
        logger.warn(undefined, "运行时偏好响应找不到 pending 请求", {
          event: "knorvia_agent.runtime_preferences.response_without_pending",
          module: "services.knorvia_agent",
          requestId: params.requestId,
        });
        throw new Error(
          `Knorvia Studio session runtime preferences request not found: ${params.requestId}`,
        );
      }
      const responseContext = {
        event: "knorvia_agent.runtime_preferences.host_response_received",
        module: "services.knorvia_agent",
        requestId: params.requestId,
        scope: pending.request.scope,
        sessionId: pending.request.sessionId,
    ...
    onDynamicSessionEvent(params: KnorviaAgentSessionSubscribeParams) {
      ...
      return (listener) => {
        ...
        const pendingLiveEvents: KnorviaAgentServiceEvent[] = [];
        ...
        const deliverToListener = (event: KnorviaAgentServiceEvent): void => {
          if (cancelled) {
            return;
          }
        ...
        const establishSubscription = async (attempt: number): Promise<void> => {
          ...
          try {
            ...
            const result = await client.request(
              knorviaProtocolMethods.sessionSubscribe,
              {
                sessionId: params.sessionId,
                deliveryKind: params.deliveryKind,
                afterSeq: params.afterSeq,
            ...
            if (attempt >= SESSION_SUBSCRIBE_MAX_ATTEMPTS - 1) {
              ...
              console.warn(
                formatLogPrefix("agent", process.pid),
    ...
    async setConnectionFlowStateV4(params: KnorviaAgentConnectionFlowParams) {
    ...
    async subscribeConversationV4(params: KnorviaAgentConversationSubscribeParams) {
      ...
      // Account Config 顺序屏障，不提升模型执行权限。Knorvia Built-in / Personal 仍由 Worker 维护。
    ...
    async unsubscribeConversationV4(params: KnorviaAgentConversationUnsubscribeParams) {
      await unsubscribeV4Route(params, "conversation/");
    },

    async resyncConversationV4(params: KnorviaAgentConversationResyncParams) {
      return resyncV4Route(params, "conversation/");
    },

    async sendConversationCommandV4(params: KnorviaAgentConversationCommandParams) {
      const client = await getClient(params);
      ...
      const commandClientMode =
        readTrustedKnorviaAgentV4Connection(params)?.clientMode ??
        params.clientMode ??
        "desktop-continuous";
    ...
    async queryConversationCommandsV4(params: KnorviaAgentCommandsQueryParams) {
      if (!readTrustedKnorviaAgentV4Connection(params)) {
    ...
    async attachmentBeginV4(params: KnorviaAgentAttachmentBeginParams) {
      const trusted = readTrustedKnorviaAgentV4Connection(params);
    ...
    async attachmentChunkV4(params: KnorviaAgentAttachmentChunkParams) {
      const trusted = readTrustedKnorviaAgentV4Connection(params);
      if (!trusted) throw new Error("fault.attachment.connectionUntrusted");
      const client = await getClient(params);
      const wireParams = {
    ...
    async attachmentCommitV4(params: KnorviaAgentAttachmentTerminalParams) {
      const trusted = readTrustedKnorviaAgentV4Connection(params);
      if (!trusted) throw new Error("fault.attachment.connectionUntrusted");
      const client = await getClient(params);
      const wireParams = {
    ...
    async attachmentAbortV4(params: KnorviaAgentAttachmentTerminalParams) {
      const trusted = readTrustedKnorviaAgentV4Connection(params);
      if (!trusted) throw new Error("fault.attachment.connectionUntrusted");
      const client = await getClient(params);
      const wireParams = {
    ...
    async attachmentReadV4(params: KnorviaAgentAttachmentReadParams) {
      if (!readTrustedKnorviaAgentV4Connection(params)) {
    ...
    async conversationAttachmentReadV4(params: KnorviaAgentConversationAttachmentReadParams) {
      if (!readTrustedKnorviaAgentV4Connection(params)) {
        throw new KnorviaAttachmentFaultError(
          KNORVIA_ATTACHMENT_FAULT_CODES.shareReadConnectionUntrusted,
        );
      }
    ...
    async conversationAttachmentStatV4(params: KnorviaAgentConversationAttachmentStatParams) {
      if (!readTrustedKnorviaAgentV4Connection(params)) {
        throw new KnorviaAttachmentFaultError(
          KNORVIA_ATTACHMENT_FAULT_CODES.shareStatConnectionUntrusted,
        );
      }
    ...
    async attachmentPreviewSourceV4(params: KnorviaAgentAttachmentPreviewSourceParams) {
      const trusted = readTrustedKnorviaAgentV4Connection(params);
    ...
    async conversationRowsRangeV4(params: KnorviaAgentConversationRowsRangeParams) {
      const trusted = readTrustedKnorviaAgentV4Connection(params);
    ...
    async conversationPlansV4(params: KnorviaAgentConversationPlansParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    async conversationWorkflowRunEventsV4(params: KnorviaAgentConversationWorkflowRunEventsParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    async conversationWorkflowRunsV4(params: KnorviaAgentConversationWorkflowRunsParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    async backgroundBashOutputV4(params: KnorviaAgentBackgroundBashOutputParams) {
      if (!readTrustedKnorviaAgentV4Connection(params))
    ...
    async conversationFileChangesV4(params: KnorviaAgentConversationFileChangesParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    async conversationFileRewindPreviewV4(params: KnorviaAgentConversationFileRewindPreviewParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    onDynamicConversationFrame(params: KnorviaAgentWorkspaceTarget) {
      return getConversationFrameEmitter(params).event;
    },

    onDynamicLocalTtftFacts(params: KnorviaAgentWorkspaceTarget) {
    ...
    onDynamicConversationTelemetryFact(params: KnorviaAgentWorkspaceTarget) {
    ...
    async subscribeSessionsIndexV4(params: KnorviaAgentSessionsIndexSubscribeParams) {
    ...
    async unsubscribeSessionsIndexV4(params: KnorviaAgentConversationUnsubscribeParams) {
      await unsubscribeV4Route(params, "sessions-index/");
    },

    async resyncSessionsIndexV4(params: KnorviaAgentConversationResyncParams) {
      return resyncV4Route(params, "sessions-index/");
    },

    onDynamicSessionsIndexFrame(params: KnorviaAgentWorkspaceTarget) {
    ...
    async subscribeWorkspaceConfigV4(params: KnorviaAgentWorkspaceConfigSubscribeParams) {
      const client = await getReadOnlyClient(params, params.runtimePolicy);
      const connection = resolveV4Connection(params, v4ConnectionIdFor(params.subscriberScope));
    ...
    async unsubscribeWorkspaceConfigV4(params: KnorviaAgentConversationUnsubscribeParams) {
      await unsubscribeV4Route(params, "workspace-config/");
    },

    async resyncWorkspaceConfigV4(params: KnorviaAgentConversationResyncParams) {
      return resyncV4Route(params, "workspace-config/");
    },

    onDynamicWorkspaceConfigFrame(params: KnorviaAgentWorkspaceTarget) {
    ...
    onAgentRuntimeLifecycle(listener: (event: KnorviaAgentRuntimeLifecycleEvent) => void) {
