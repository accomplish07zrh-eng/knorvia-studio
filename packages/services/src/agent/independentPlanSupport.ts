import { knorviaProtocolMethods, knorviaRuntimeCapabilitiesSchema } from "@knorvia/shared";
import type { KnorviaProtocolClient } from "./protocolClient.js";
...
export function ensureIndependentPlanSupport(
  ...
  const check = client
    .request(knorviaProtocolMethods.runtimeCapabilities, {}, knorviaRuntimeCapabilitiesSchema)
    .then((result) => {
