import type { Hook, KnorviaWorkspaceHookTrustGrantResult } from "@knorvia/shared";
import type { WorkspaceHookBundleSnapshotData } from "@knorvia/shared/workspace-hook-discovery";
