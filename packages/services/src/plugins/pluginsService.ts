import type { PluginScope, PluginsOverviewResult } from "@knorvia/shared";
...
function throwRetiredPluginManagement(): never {
  throw new Error("Legacy plugin management has been retired in Knorvia Studio Agent mode");
}
