...
import type { IStudioRuntimeService } from "./studio-runtime/contract.js";
...
import type { IKnorviaSessionService } from "./agent-session/session.js";
...
export interface IServiceAccessor {
  ...
  /** 设置页插件管理（UI 不再直触 agentService 的 plugins/* 面） */
