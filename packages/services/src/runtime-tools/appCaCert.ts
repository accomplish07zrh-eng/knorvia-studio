...
const APP_CA_CERT_FILE = "knorvia-network-ca.pem";
const APP_CA_KEY_FILE = "knorvia-network-ca.key";
...
function generateSelfSignedCa(): { certPem: string; keyPem: string } {
  ...
  const attrs = [
    { name: "commonName", value: "Knorvia Studio Network CA" },
    { name: "organizationName", value: "Knorvia Studio" },
  ];
