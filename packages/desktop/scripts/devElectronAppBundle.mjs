...
export const DEV_ELECTRON_PROTOCOL_SCHEME = "knorvia";
export const DEV_ELECTRON_APP_NAME = "Knorvia Studio Dev";
export const DEV_ELECTRON_APP_BUNDLE_ID = "dev.knorvia-studio.app.development";
...
/**
 * 为 macOS 本地 Dev runtime 写入产品身份和 knorvia URL scheme。
 * raw Electron 的 Info.plist 没有 CFBundleURLTypes，系统只能把 knorvia 交给
...
export async function prepareDevElectronAppBundle({
  ...
  const sourceStampPath = join(dirname(appPath), ".knorvia-studio-dev-electron-source.json");
