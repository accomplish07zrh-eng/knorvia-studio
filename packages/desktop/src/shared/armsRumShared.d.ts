import { type KnorviaRuntimeEnv } from "@knorvia/shared";
...
export declare function buildArmsBrowserInitConfig(runtimeEnv: KnorviaRuntimeEnv): {
  enable: boolean;
  version: string;
  endpoint: string;
  env: import("@knorvia/shared").ArmsRumEnv;
  sessionConfig: {
    sampleRate: number;
  };
  spaMode: false;
