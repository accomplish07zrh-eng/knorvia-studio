...
const WORKFLOW_NAME = "Open in Knorvia Studio.workflow";
const WORKFLOW_BUNDLE_ID = "dev.knorvia.studio.finder-open-workflow";
const WORKFLOW_VERSION = "5";
const SERVICES_MENU_LABELS: Record<Locale, string> = {
  "zh-CN": "在 Knorvia Studio 中打开",
  "en-US": "Open in Knorvia Studio",
};
...
if [ -n "$first" ]; then
  ...
  /usr/bin/open "knorvia-studio://workspace/open?path=\${encoded}"
fi
`;
