...
import type { ApplicationIconInfo } from "@knorvia/shared";
...
public static class KnorviaAumidIcon {
...
'@;
$knorviaIconBytes=[KnorviaAumidIcon]::Read($knorviaArg0);
[Console]::Out.Write([Convert]::ToBase64String($knorviaIconBytes));
`;
