...
import { HELPER_APP_NAME } from "@knorvia/cua/broker/helperConstants";
import {
...
export { normalizeCuaHelperArch, normalizeCuaHelperArchs } from "@knorvia/services/node";
...
export function createDesktopCuaHelperInstaller(
  ...
  if (bundledAppPath) {
    delete env.KNORVIA_CUA_HELPER_ALLOW_UNSIGNED_LOCAL;
  }
