...
const RPC_NESTED_UINT8_ARRAY_MARKER = "__knorvia_rpc_nested_uint8array_v1";
const LEGACY_RPC_NESTED_UINT8_ARRAY_MARKER = "__zcode_rpc_nested_uint8array_v1";
...
function isRpcEncodedUint8Array(value: unknown): value is {
  ...
  return (
    (record[RPC_NESTED_UINT8_ARRAY_MARKER] === true ||
      record[LEGACY_RPC_NESTED_UINT8_ARRAY_MARKER] === true) &&
