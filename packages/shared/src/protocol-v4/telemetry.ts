import { z } from "zod";
import { knorviaSyntheticUserMessageSourceSchema } from "../protocol-legacy-types.js";
...
const turnStartedFactSchema = z
  .object({
    ...
    inputSource: knorviaSyntheticUserMessageSourceSchema.optional(),
...
const toolLifecycleFactSchema = z
  .object({
    ...
    skillSource: z.enum(["agents", "knorvia", "bundled", "plugin", "remote"]).optional(),
...
type TurnStartedConversationTelemetryFact = Extract<
  ...
  { kind: "turn.started" }
> &
  import("../task-types-core.js").KnorviaBackgroundTurnAttribution;
