export const KNORVIA_AGENT_PROVIDER_NOT_READY_CODE = "KNORVIA_AGENT_PROVIDER_NOT_READY" as const;
export const KNORVIA_AGENT_PROVIDER_NOT_READY_REASON = "provider_not_ready" as const;
