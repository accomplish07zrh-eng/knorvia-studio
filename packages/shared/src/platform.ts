...
export const BROWSER_VIEW_RESTORE_BOOTSTRAP_URL = "knorvia-browser-restore://pending";
...
export const LOCAL_MEDIA_PREVIEW_SCHEME = "knorvia-media";
...
export const DesktopCommandIds = {
  ...
  ToggleKnorviaStdioTapDevProxy: "toggleKnorviaStdioTapDevProxy",
  SetKnorviaEndpointProduction: "setKnorviaEndpointProduction",
  SetKnorviaEndpointTest: "setKnorviaEndpointTest",
  SetKnorviaEndpointCustom: "setKnorviaEndpointCustom",
  ResetKnorviaEndpoint: "resetKnorviaEndpoint",
...
export interface IPlatformService {
  ...
  /**
   * 在宿主 ~/.knorvia-studio 临时目录创建文本附件文件。
  ...
  /** 打开 Knorvia Computer Use 的完整权限引导。Desktop only。 */
  ...
  ): Promise<import("./localDiagnostics.js").LocalDiagnosticPreview>;
  ...
  /** Set only this window's native material; false means the OS cannot provide it. */
