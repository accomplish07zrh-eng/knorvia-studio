...
export interface SkillSummary {
   ...
   * 软链导入的技能里 `path` 是 realpath 后的目标文件，`sourcePath` 才指向 `~/.knorvia-studio/skills/<name>` 下的链接本体，
...
/** 与 cli `SkillDiagnosticCode` 同步。变动时一并改 apps/cli/packages/contracts/src/skills/index.ts。 */
