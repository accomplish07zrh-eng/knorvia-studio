export type BuiltinKnorviaSlashCommandHelpEntry = {
...
export const BUILTIN_KNORVIA_SLASH_COMMAND_HELP_ENTRIES: readonly BuiltinKnorviaSlashCommandHelpEntry[] =
  [
    {
      details: [
    ...
    },
    {
      details: [
        ...
        "This command targets the workspace root, not the user default ~/.knorvia-studio/AGENTS.md.",
      ],
      name: "init",
