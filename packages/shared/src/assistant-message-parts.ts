export type KnorviaAssistantMessagePart =
  | {
      type: "content";
      content: string;
    }
...
export function appendAssistantMessagePart(
  parts: readonly KnorviaAssistantMessagePart[] | undefined,
  nextPart: KnorviaAssistantMessagePart,
) {
...
export function getLatestAssistantContentPart(parts: readonly KnorviaAssistantMessagePart[]) {
...
export function getLatestAssistantContentText(parts: readonly KnorviaAssistantMessagePart[]) {
