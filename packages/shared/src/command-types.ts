...
export type CommandAgentSource = "agent";
...
export type KnorviaCommand = UserCommand | PluginCommand;

export function isUserCommand(command: KnorviaCommand): command is UserCommand {
  return command.source === "user";
}

export function isPluginCommand(command: KnorviaCommand): command is PluginCommand {
