...
export const BROKER_SOCKET_ENV = "KNORVIA_CUA_PERMISSION_BROKER_SOCKET";
export const BROKER_UNAVAILABLE_ENV = "KNORVIA_CUA_PERMISSION_BROKER_UNAVAILABLE";
...
export function mintBrokerSocketPath(options = {}) {
  ...
  return join(dir, `cua-broker-${randomUUID()}.sock`);
}
