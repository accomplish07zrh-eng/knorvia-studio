...
export const HELPER_ADDON_ENV = "KNORVIA_CUA_HELPER_ADDON";
export const WINDOWS_DEV_CONTROL_PROTOCOL = "knorvia-cua-windows-dev/v1";
...
export function isPotentialKnorviaCuaAgentMcpServer(_server) {
  return false;
}
