declare module "*.css";
declare module "@knorvia/ui/styles.css";
...
interface ImportMetaEnv {
  ...
  readonly VITE_KNORVIA_BASE_URL?: string;
  readonly VITE_KNORVIA_ENDPOINT_ORIGIN?: string;
  readonly VITE_KNORVIA_WEB_REMOTE_CONTROL_RELAY_WS_URL?: string;
}
