...
- 2026-09-26 用户授权导航布局改为窄工具栏、内核切换区与内容侧栏，插件管理直达入口也移到窄栏；会话侧栏与主内容共用一个圆角工作面，标题栏独立在上方，见 `specs/knorvia-activity-rail.md`。此项替代上文主导航布局不变与插件仅位于设置侧栏的限制，仍沿用原业务组件与黑白视觉语言。
