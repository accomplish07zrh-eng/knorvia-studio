...
import { ModelApiActorKind, ModelApiOperation, ModelRequestSessionType } from "@knorvia/contracts";
import { isOpenCodeGoBaseUrl } from "./opencode-session.js";
import type { ModelStatusContext } from "./runner-status.js";

const MODEL_TRACE_HEADER = "x-knorvia-trace-id";
...
const MODEL_SESSION_TYPE_HEADER = "x-agent-session-type";
