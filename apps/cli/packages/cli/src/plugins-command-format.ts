import { formatJson } from "@knorvia/core";
import type { GlobalOptions, JsonValue, RunContext } from "@knorvia/shared-types";
import type {
...
export function formatHumanAvailableList(plugins: readonly KnorviaAvailablePluginData[]): string {
...
export function formatHumanMarketplaceList(
  marketplaces: readonly KnorviaMarketplaceSummaryData[],
): string {
...
export function formatHumanPluginSet(result: SetKnorviaPluginEnabledResult): string {
...
export const formatPluginSetJson = (result: SetKnorviaPluginEnabledResult): string =>
  formatJson({
...
export function formatAvailablePluginJson(plugin: KnorviaAvailablePluginData) {
  return {
    id: plugin.id,
...
export function formatInstalledPluginJson(plugin: KnorviaInstalledPluginData) {
  return {
    enabled: plugin.enabled,
    id: plugin.id,
    marketplace: plugin.marketplace,
...
export function formatMarketplaceJson(marketplace: KnorviaMarketplaceSummaryData) {
  return {
    id: marketplace.id,
