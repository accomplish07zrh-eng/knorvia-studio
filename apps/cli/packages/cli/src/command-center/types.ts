...
import type { SupportedLocale, UiLocale } from "@knorvia/i18n";
import type { ModelSelection, KnorviaModelOption } from "@knorvia/shared";
import type {
...
export type CommandCenterModelOption = KnorviaModelOption;
...
export type CommandCenterApp = {
  ...
  readSubagents?: import("@knorvia/tui").TuiReadSubagents;
  readSubagentTranscript?: import("@knorvia/tui").TuiReadSubagentTranscript;
