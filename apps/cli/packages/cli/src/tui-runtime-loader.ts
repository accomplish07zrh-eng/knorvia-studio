...
import type { runTui } from "@knorvia/tui";
...
const assetPrefix = "knorvia-tui-runtime/";
const manifestAssetKey = `${assetPrefix}manifest.json`;
const packageEntryPath = "node_modules/@knorvia/tui/dist/index.js";
...
export const loadTuiRuntime = async (): Promise<TuiRuntimeModule> => {
  ...
  if (!sea.isSea()) {
    return await import("@knorvia/tui");
  }
