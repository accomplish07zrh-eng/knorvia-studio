...
With no command, knorvia opens the full-screen TUI.

Commands:
  app-server Run the Knorvia Studio Protocol stdio app server
...
`,
  ...
  tui: {
    ...
    terminal: {
      ...
      starting: "Starting Knorvia Studio... Ctrl+C to exit",
    },
    transcript: {
      compact: {
