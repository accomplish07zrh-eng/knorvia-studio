...
interface PersistedConversationMaterializationStore {
  getSession(sessionId: import("@knorvia/contracts").SessionId): Promise<{
    title?: string;
    revert?: {
      branchCutAfterMessageID?: import("@knorvia/contracts").MessageId;
      branchGeneration?: number;
      createdMessageID?: import("@knorvia/contracts").MessageId;
      keptMessageIDs?: import("@knorvia/contracts").MessageId[];
...
export async function loadPersistedConversationMaterialization(input: {
  ...
  const sessionID = input.sessionId as import("@knorvia/contracts").SessionId;
