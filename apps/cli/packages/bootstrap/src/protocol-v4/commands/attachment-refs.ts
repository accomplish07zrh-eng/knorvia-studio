...
// 1. URI ref（knorvia-artifact:// 等带 scheme:/）——经 attachment chunk transaction 寄存的内容引用：
...
import type { TurnAttachment } from "@knorvia/core";
...
async function mapAttachmentRef(app: KnorviaApp, ref: AttachmentRef): Promise<TurnAttachment> {
