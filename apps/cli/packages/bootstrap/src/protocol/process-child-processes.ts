import type { McpTrackedProcess } from "@knorvia/adapters";
import type { KnorviaProcessChildProcessesResult } from "@knorvia/shared";
...
): KnorviaProcessChildProcessesResult {
  return {
