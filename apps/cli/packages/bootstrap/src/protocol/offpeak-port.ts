import type { OffPeakPort, OffPeakTaskSummary } from "@knorvia/contracts";
import {
  knorviaOffPeakCreateResultSchema,
  knorviaOffPeakListResultSchema,
  knorviaProtocolMethods,
  type KnorviaOffPeakTaskProtocolSnapshot,
} from "@knorvia/shared";
import type {
...
function toOffPeakTaskSummary(input: KnorviaOffPeakTaskProtocolSnapshot): OffPeakTaskSummary {
  return {
