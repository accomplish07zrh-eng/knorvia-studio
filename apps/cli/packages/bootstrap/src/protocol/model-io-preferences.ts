import { knorviaWorkspaceUpdateModelIoPreferencesParamsSchema } from "@knorvia/shared";
...
export async function updateModelIoPreferences(
  ...
  const params = parseParams(knorviaWorkspaceUpdateModelIoPreferencesParamsSchema, rawParams);
