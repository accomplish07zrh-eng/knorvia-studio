import { knorviaWorkspaceUpdateDynamicWorkflowPolicyParamsSchema } from "@knorvia/shared";
...
export async function updateDynamicWorkflowPolicy(
  ...
  const params = parseParams(knorviaWorkspaceUpdateDynamicWorkflowPolicyParamsSchema, rawParams);
