import { parseRemoteWorkspaceIdentity, type KnorviaWorkspaceRef } from "@knorvia/shared";
 ...
 */
export function resolveWorkspaceRefFromId(workspaceId: string): KnorviaWorkspaceRef {
