...
import { getKnorviaAgentModeSelectOptions, normalizeAvailableKnorviaMode } from "@knorvia/shared";
import type { KnorviaSessionSettingsState, KnorviaSlashCommand } from "@knorvia/shared";
import type { WorkspaceConfigState } from "@knorvia/shared/protocol-v4";
 ...
 * 创建临时 app 并被 MCP close 拖住协议通道（见 desktop warmUpKnorviaAgent 的注释）。
