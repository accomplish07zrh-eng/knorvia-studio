import { knorviaWorkspaceUpdateOffPeakToolPolicyParamsSchema } from "@knorvia/shared";
...
export async function updateOffPeakToolPolicy(
  ...
  const params = parseParams(knorviaWorkspaceUpdateOffPeakToolPolicyParamsSchema, rawParams);
