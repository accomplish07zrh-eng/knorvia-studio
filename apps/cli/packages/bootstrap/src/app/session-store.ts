...
import { SqliteSessionStore } from "@knorvia/adapters/storage";
import { resolvePath, type ConfigResult } from "@knorvia/adapters/config";
import {
...
import type { ModelSelection } from "@knorvia/provider";
...
export async function openStartupSessionStore(
  ...
  startupTimer.start("Knorvia Studio SQLite migration started", {
    context: { dbPath },
  ...
  startupTimer.mark("Knorvia Studio SQLite migration completed", {
    context: { dbPath },
