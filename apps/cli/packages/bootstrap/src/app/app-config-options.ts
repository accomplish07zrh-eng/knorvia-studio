...
import { detectLocale, resolveLocale } from "@knorvia/i18n";
import type { RuntimeConfigPatch, SupportedLocale, UiLocale } from "@knorvia/contracts";
...
function detectAppLocale(options: KnorviaAppOptions): SupportedLocale | undefined {
