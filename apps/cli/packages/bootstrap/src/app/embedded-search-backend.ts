import type { EmbeddedSearchBackend } from "@knorvia/contracts";
import { getRuntimeToolRuntime } from "@knorvia/shared";

const EMBEDDED_SEARCH_COMMAND_ENV = "KNORVIA_EMBEDDED_SEARCH_COMMAND";
