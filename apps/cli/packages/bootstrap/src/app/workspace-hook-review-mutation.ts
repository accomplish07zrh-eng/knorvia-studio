...
import { digestSummary, workspaceIdentitySummary } from "@knorvia/core";
import {
...
} from "@knorvia/shared/workspace-hook-mutation";
...
export function createWorkspaceHookReviewMutationPort(
  ...
  const editableConfigPath = resolve(workingDirectory, ".knorvia-studio", "config.json");
