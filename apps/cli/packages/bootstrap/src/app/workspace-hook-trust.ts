import { createDefaultFileWorkspaceHookTrustStore } from "@knorvia/adapters/storage";
import {
...
import type { WorkspaceHookRuntimeRoot } from "@knorvia/shared/workspace-hook-discovery";
import {
...
export function createWorkspaceHookRuntimeSecurity(input: {
  ...
  /** 测试注入临时 HOME；生产不传，Trust store 落在真实 ~/.knorvia-studio/security。 */
  homeDir?: string;
