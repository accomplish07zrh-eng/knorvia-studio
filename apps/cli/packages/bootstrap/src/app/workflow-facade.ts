...
import { createNodeExecutionAdapter } from "@knorvia/adapters/exec";
...
} from "@knorvia/adapters/workflow";
import {
  AgentRuntime,
...
import type { PrepareUserExecutionBoundary, KnorviaAppOptions } from "./types.js";
...
function createWorkflowChildRuntime(
  ...
  return new AgentRuntime(
    ...
    {
      ...deps.runtimeConfig,
      agentName: options.workflowKind === "expert" ? "knorvia-expert" : "knorvia-workflow",
      mode: "yolo",
    ...
    },
    {
      ...
      ...deps.runtime.createChildClientPorts({
        ...
        agentType: options.workflowKind === "expert" ? "knorvia-expert" : "knorvia-workflow",
