...
import type { DynamicWorkflowRunProgressPayload, Logger, SessionId } from "@knorvia/contracts";
 ...
 *
 *   KnorviaApp ──1:1── AgentRuntime ──1:1── sessionId        （create-app：`new AgentRuntime(sessionId, …)`）
