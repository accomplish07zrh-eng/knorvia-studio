...
import { BUILTIN_PROVIDER_TEMPLATE_IDS } from "@knorvia/shared";
import { getDefaultConfigPath } from "@knorvia/adapters/config";
import {
...
function importLegacyCliPersonalProviderConfig(
  ...
  // 通用 KnorviaConfigFileSchema 刻意把旧 provider 留在 passthrough unknown，
