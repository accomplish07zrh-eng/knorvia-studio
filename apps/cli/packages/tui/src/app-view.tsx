import type { ModelUsageSummary, TodoItem, TurnId } from "@knorvia/contracts";
import React from "react";
import { ApprovalPanel } from "./app-approval-panel.js";
import {
  actionPanelContentWidthForTerminal,
  AppShell,
  ModelConfigurationRequiredPanel,
...
export function AppView(props: {
  ...
  copy: ReturnType<typeof import("@knorvia/i18n").getKnorviaCopy>["tui"];
  ...
  const mcpStatus = useMcpSidebarStatus(
    props.modelConfigurationRequired ? undefined : props.options.listMcpServers,
  );
      ...
      props.approvalQueue[0]
        ...
        : actionSelection
          ...
          : h(ComposerInputArea, {
              ...
              modelConfigurationRequired: props.modelConfigurationRequired,
              mode: props.mode,
